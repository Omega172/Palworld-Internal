...
void UBP_AIAction_NPC_CombatBase_C::IsTargetOnSea(bool* OnSea)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_NPC_CombatBase_C", "IsTargetOnSea");

	Params::BP_AIAction_NPC_CombatBase_C_IsTargetOnSea Parms{};
...
void UBP_AIAction_NPC_CombatBase_C::RayCheckToGround(struct FVector* Location)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_NPC_CombatBase_C", "RayCheckToGround");

	Params::BP_AIAction_NPC_CombatBase_C_RayCheckToGround Parms{};
