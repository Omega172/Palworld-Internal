...
public:
	...
	uint8                                         Pad_53FB[0x7];                                     // 0x05B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnReturnSpawnedPoint;                              // 0x05C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FVector                                Formation_Offset;                                  // 0x05D0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnBaseCampArrived;                                 // 0x05E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(ABP_NPCAIController_Visitor_C) == 0x0005F8, "Wrong size on ABP_NPCAIController_Visitor_C");
...
static_assert(offsetof(ABP_NPCAIController_Visitor_C, OnReturnSpawnedPoint) == 0x0005C0, "Member 'ABP_NPCAIController_Visitor_C::OnReturnSpawnedPoint' has a wrong offset!");
static_assert(offsetof(ABP_NPCAIController_Visitor_C, Formation_Offset) == 0x0005D0, "Member 'ABP_NPCAIController_Visitor_C::Formation_Offset' has a wrong offset!");
static_assert(offsetof(ABP_NPCAIController_Visitor_C, OnBaseCampArrived) == 0x0005E8, "Member 'ABP_NPCAIController_Visitor_C::OnBaseCampArrived' has a wrong offset!");
