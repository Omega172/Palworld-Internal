...
public:
	...
	uint8                                         Pad_55A4[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli) == 0x0000A8, "Wrong size on BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli");
...
static_assert(offsetof(BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000020, "Member 'BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli, K2Node_DynamicCast_AsPal_AIAction_Component) == 0x000038, "Member 'BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli::K2Node_DynamicCast_AsPal_AIAction_Component' has a wrong offset!");
static_assert(offsetof(BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli, K2Node_DynamicCast_bSuccess) == 0x000040, "Member 'BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli, CallFunc_GetComponentByClass_ReturnValue) == 0x000048, "Member 'BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli, K2Node_MakeStruct_PalAIActionDynamicParameter) == 0x000050, "Member 'BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli::K2Node_MakeStruct_PalAIActionDynamicParameter' has a wrong offset!");
static_assert(offsetof(BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli, CallFunc_SetActionClassParameter_ReturnValue) == 0x0000A0, "Member 'BP_AIController_CombatHeli_C_ExecuteUbergraph_BP_AIController_CombatHeli::CallFunc_SetActionClassParameter_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_55A6[0x7];                                     // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
