...
public:
	...
	TArray<class UWBP_MapFilter_Content_C*>       Filters;                                           // 0x02C0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TMap<EPalLocationType, struct FDataTableRowHandle> FilterMsgMap;                                      // 0x02D0(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	FMulticastInlineDelegateProperty_             OnFilterChanged;                                   // 0x0320(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UWBP_MapFilter_Win_C) == 0x000330, "Wrong size on UWBP_MapFilter_Win_C");
...
static_assert(offsetof(UWBP_MapFilter_Win_C, WBP_MapFilter_Content_6) == 0x0002B0, "Member 'UWBP_MapFilter_Win_C::WBP_MapFilter_Content_6' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, WBP_MapFilter_Content_7) == 0x0002B8, "Member 'UWBP_MapFilter_Win_C::WBP_MapFilter_Content_7' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, Filters) == 0x0002C0, "Member 'UWBP_MapFilter_Win_C::Filters' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, FilterMsgMap) == 0x0002D0, "Member 'UWBP_MapFilter_Win_C::FilterMsgMap' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, OnFilterChanged) == 0x000320, "Member 'UWBP_MapFilter_Win_C::OnFilterChanged' has a wrong offset!");
