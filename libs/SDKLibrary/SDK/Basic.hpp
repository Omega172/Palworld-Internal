...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08B81800;
	constexpr int32 AppendString      = 0x02F45280;
	constexpr int32 GNames            = 0x08AE2100;
	constexpr int32 GWorld            = 0x08CEFFC0;
	constexpr int32 ProcessEvent      = 0x030C8270;
