...
public:
	...
	uint8                                         Pad_1484[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1486[0x88];                                    // 0x0000(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1487[0x38];                                    // 0x0090(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1488[0x28];                                    // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_1489[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
