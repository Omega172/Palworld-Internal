...
// Function WBP_PalGetReticle.WBP_PalGetReticle_C.AnmEvent_CountupCriticalBonus
// (BlueprintCallable, BlueprintEvent)

void UWBP_PalGetReticle_C::AnmEvent_CountupCriticalBonus()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalGetReticle_C", "AnmEvent_CountupCriticalBonus");
...
void UWBP_PalGetReticle_C::Set_Bonus_Flags(bool bIsSneakBonus, bool bIsCriticalBonus)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalGetReticle_C", "Set Bonus Flags");

	Params::WBP_PalGetReticle_C_Set_Bonus_Flags Parms{};
...
void UWBP_PalGetReticle_C::SetCriticalCaptureRate(TArray<double>& RateArray)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalGetReticle_C", "SetCriticalCaptureRate");

	Params::WBP_PalGetReticle_C_SetCriticalCaptureRate Parms{};
