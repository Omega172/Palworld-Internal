...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   Param_CurrentHP                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   MaxHP                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Ingame_InteractDurability_C::OnCannonHPUpdate(float Param_CurrentHP, float MaxHP)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_CurrentHP = Param_CurrentHP;
	Parms.MaxHP = MaxHP;
...
// Parameters:
// double                                  Param_CurrentHP                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  MaxHP                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Ingame_InteractDurability_C::UpdateHP_Internal(double Param_CurrentHP, double MaxHP)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Ingame_InteractDurability_C", "UpdateHP_Internal");

	Params::WBP_Ingame_InteractDurability_C_UpdateHP_Internal Parms{};
