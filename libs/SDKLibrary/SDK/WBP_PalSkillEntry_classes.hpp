...
static_assert(sizeof(UWBP_PalSkillEntry_C) == 0x0002D8, "Wrong size on UWBP_PalSkillEntry_C");
...
static_assert(offsetof(UWBP_PalSkillEntry_C, OverridePadActionName_Additional) == 0x0002D0, "Member 'UWBP_PalSkillEntry_C::OverridePadActionName_Additional' has a wrong offset!");
