...
public:
	...
	uint8                                         Pad_4271[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4273[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4274[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalCharacterMovementComponent*         K2Node_ComponentBoundEvent_component;              // 0x0090(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalCharacterOnCompleteInitializeParameterWrapper* CallFunc_GetOnCompleteInitializeParameterDelegate_ReturnValue; // 0x0098(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalSoundOptions                       K2Node_MakeStruct_PalSoundOptions;                 // 0x00A0(0x0004)(NoDestructor)
	bool                                          K2Node_CustomEvent_Active;                         // 0x00A4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base, K2Node_Event_EndPlayReason) == 0x000088, "Member 'BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base::K2Node_Event_EndPlayReason' has a wrong offset!");
static_assert(offsetof(BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base, K2Node_ComponentBoundEvent_component) == 0x000090, "Member 'BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base::K2Node_ComponentBoundEvent_component' has a wrong offset!");
static_assert(offsetof(BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base, CallFunc_GetOnCompleteInitializeParameterDelegate_ReturnValue) == 0x000098, "Member 'BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base::CallFunc_GetOnCompleteInitializeParameterDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base, K2Node_MakeStruct_PalSoundOptions) == 0x0000A0, "Member 'BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base::K2Node_MakeStruct_PalSoundOptions' has a wrong offset!");
static_assert(offsetof(BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base, K2Node_CustomEvent_Active) == 0x0000A4, "Member 'BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base::K2Node_CustomEvent_Active' has a wrong offset!");
static_assert(offsetof(BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base, CallFunc_GetController_ReturnValue) == 0x0000A8, "Member 'BP_NPC_Base_C_ExecuteUbergraph_BP_NPC_Base::CallFunc_GetController_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4276[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
