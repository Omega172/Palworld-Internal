...
public:
	...
	class UBP_PalTextBlock_C*                     Text_WorkHardType;                                 // 0x0338(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           VerticalBox_All;                                   // 0x0340(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UVerticalBox*                           VerticalBox_TaskDetail;                            // 0x0348(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_IngameMenu_Task_SimpleList_C*      WBP_IngameMenu_Task_SimpleList;                    // 0x0350(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_IngameMenu_Task_SimpleList_C*      WBP_IngameMenu_Task_SimpleList_1;                  // 0x0358(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_IngameMenu_Task_SimpleList_C*      WBP_IngameMenu_Task_SimpleList_2;                  // 0x0360(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_IngameMenu_Task_SimpleList_C*      WBP_IngameMenu_Task_SimpleList_3;                  // 0x0368(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_IngameMenu_Task_SimpleList_C*      WBP_IngameMenu_Task_SimpleList_4;                  // 0x0370(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_IngameMenu_TaskMaterial_C*         WBP_IngameMenu_TaskMaterial;                       // 0x0378(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWrapBox*                               WrapBox_ItemInfo;                                  // 0x0380(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UWBP_IngameMenu_Task_SimpleList_C*> PalDetailWidgetArray;                              // 0x0388(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	struct FSlateFontInfo                         TaskDetailBaseFont;                                // 0x0398(0x0060)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	class UMaterial*                              CompletedTaskFontMaterial;                         // 0x03F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UMaterial*                              IncompletedTaskFontMaterial;                       // 0x0400(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FDataTableRowHandle                    buildTaskMsgID;                                    // 0x0408(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    WorkerTaskMsgID;                                   // 0x0418(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	TMap<EPalBaseCampWorkerDirectionBattleType, struct FDataTableRowHandle> BattleTypeMsgMap;                                  // 0x0428(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<EPalBaseCampWorkerDirectionBattleType, TSoftObjectPtr<class UTexture2D>> BattleTypeIconMap;                                 // 0x0478(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<EPalBaseCampPassiveEffectWorkHardType, struct FDataTableRowHandle> WorkHardTypeMsgMap;                                // 0x04C8(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<EPalBaseCampPassiveEffectWorkHardType, TSoftObjectPtr<class UTexture2D>> WorkHardTypeIconMap;                               // 0x0518(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UWBP_IngameMenu_Task_Simple_C) == 0x000568, "Wrong size on UWBP_IngameMenu_Task_Simple_C");
...
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, Text_WorkHardType) == 0x000338, "Member 'UWBP_IngameMenu_Task_Simple_C::Text_WorkHardType' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, VerticalBox_All) == 0x000340, "Member 'UWBP_IngameMenu_Task_Simple_C::VerticalBox_All' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, VerticalBox_TaskDetail) == 0x000348, "Member 'UWBP_IngameMenu_Task_Simple_C::VerticalBox_TaskDetail' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WBP_IngameMenu_Task_SimpleList) == 0x000350, "Member 'UWBP_IngameMenu_Task_Simple_C::WBP_IngameMenu_Task_SimpleList' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WBP_IngameMenu_Task_SimpleList_1) == 0x000358, "Member 'UWBP_IngameMenu_Task_Simple_C::WBP_IngameMenu_Task_SimpleList_1' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WBP_IngameMenu_Task_SimpleList_2) == 0x000360, "Member 'UWBP_IngameMenu_Task_Simple_C::WBP_IngameMenu_Task_SimpleList_2' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WBP_IngameMenu_Task_SimpleList_3) == 0x000368, "Member 'UWBP_IngameMenu_Task_Simple_C::WBP_IngameMenu_Task_SimpleList_3' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WBP_IngameMenu_Task_SimpleList_4) == 0x000370, "Member 'UWBP_IngameMenu_Task_Simple_C::WBP_IngameMenu_Task_SimpleList_4' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WBP_IngameMenu_TaskMaterial) == 0x000378, "Member 'UWBP_IngameMenu_Task_Simple_C::WBP_IngameMenu_TaskMaterial' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WrapBox_ItemInfo) == 0x000380, "Member 'UWBP_IngameMenu_Task_Simple_C::WrapBox_ItemInfo' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, PalDetailWidgetArray) == 0x000388, "Member 'UWBP_IngameMenu_Task_Simple_C::PalDetailWidgetArray' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, TaskDetailBaseFont) == 0x000398, "Member 'UWBP_IngameMenu_Task_Simple_C::TaskDetailBaseFont' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, CompletedTaskFontMaterial) == 0x0003F8, "Member 'UWBP_IngameMenu_Task_Simple_C::CompletedTaskFontMaterial' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, IncompletedTaskFontMaterial) == 0x000400, "Member 'UWBP_IngameMenu_Task_Simple_C::IncompletedTaskFontMaterial' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, buildTaskMsgID) == 0x000408, "Member 'UWBP_IngameMenu_Task_Simple_C::buildTaskMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WorkerTaskMsgID) == 0x000418, "Member 'UWBP_IngameMenu_Task_Simple_C::WorkerTaskMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, BattleTypeMsgMap) == 0x000428, "Member 'UWBP_IngameMenu_Task_Simple_C::BattleTypeMsgMap' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, BattleTypeIconMap) == 0x000478, "Member 'UWBP_IngameMenu_Task_Simple_C::BattleTypeIconMap' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WorkHardTypeMsgMap) == 0x0004C8, "Member 'UWBP_IngameMenu_Task_Simple_C::WorkHardTypeMsgMap' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Task_Simple_C, WorkHardTypeIconMap) == 0x000518, "Member 'UWBP_IngameMenu_Task_Simple_C::WorkHardTypeIconMap' has a wrong offset!");
