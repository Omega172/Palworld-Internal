...
static_assert(sizeof(ABP_DungeonAreaVolume_C) == 0x0002D8, "Wrong size on ABP_DungeonAreaVolume_C");
static_assert(offsetof(ABP_DungeonAreaVolume_C, UberGraphFrame) == 0x0002C8, "Member 'ABP_DungeonAreaVolume_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_DungeonAreaVolume_C, Box) == 0x0002D0, "Member 'ABP_DungeonAreaVolume_C::Box' has a wrong offset!");
