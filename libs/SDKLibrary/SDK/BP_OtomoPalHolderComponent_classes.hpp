...
public:
	...
	bool                                          OtomoDespawnable;                                  // 0x0188(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          DisableOtomoCollision;                             // 0x0189(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void GetAIClass(class UClass** Param_Class);
...
static_assert(sizeof(UBP_OtomoPalHolderComponent_C) == 0x000190, "Wrong size on UBP_OtomoPalHolderComponent_C");
...
static_assert(offsetof(UBP_OtomoPalHolderComponent_C, OtomoDespawnable) == 0x000188, "Member 'UBP_OtomoPalHolderComponent_C::OtomoDespawnable' has a wrong offset!");
static_assert(offsetof(UBP_OtomoPalHolderComponent_C, DisableOtomoCollision) == 0x000189, "Member 'UBP_OtomoPalHolderComponent_C::DisableOtomoCollision' has a wrong offset!");
