...
public:
	...
	bool                                          Is_Authentication;                                 // 0x0540(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_IngameMenu_Chest_LockPass_C) == 0x000548, "Wrong size on UWBP_IngameMenu_Chest_LockPass_C");
...
static_assert(offsetof(UWBP_IngameMenu_Chest_LockPass_C, Is_Authentication) == 0x000540, "Member 'UWBP_IngameMenu_Chest_LockPass_C::Is_Authentication' has a wrong offset!");
