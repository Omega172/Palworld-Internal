...
public:
	...
	uint8                                         Pad_58C6[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_HomingMissile_MissileLauncher_NPC_C_Find_Target_Actor) == 0x000028, "Wrong size on BP_HomingMissile_MissileLauncher_NPC_C_Find_Target_Actor");
