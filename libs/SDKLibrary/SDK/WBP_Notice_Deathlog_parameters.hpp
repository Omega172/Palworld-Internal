...
public:
	...
	uint8                                         Pad_3A9B[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A9C[0x2];                                     // 0x0052(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_2;            // 0x0054(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3A9D[0x4];                                     // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A9E[0x6];                                     // 0x007A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3A9F[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FPalKillLogDisplayData                 DisplayData;                                       // 0x0000(0x0058)(BlueprintVisible, BlueprintReadOnly, Parm)
	class FText                                   AttackerName;                                      // 0x0058(0x0018)(Parm, OutParm)
	class FText                                   DefenderName;                                      // 0x0070(0x0018)(Parm, OutParm)
	class FText                                   Reason;                                            // 0x0088(0x0018)(Parm, OutParm)
	class FText                                   CallFunc_GetDeathResonText_ReasonText;             // 0x00A0(0x0018)()
...
static_assert(sizeof(WBP_Notice_Deathlog_C_MakeDeathLogText) == 0x0001D8, "Wrong size on WBP_Notice_Deathlog_C_MakeDeathLogText");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, AttackerName) == 0x000058, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, DefenderName) == 0x000070, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, Reason) == 0x000088, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::Reason' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_GetDeathResonText_ReasonText) == 0x0000A0, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_GetDeathResonText_ReasonText' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Conv_StringToText_ReturnValue) == 0x0000B8, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Conv_StringToText_ReturnValue_1) == 0x0000D0, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeStruct_FormatArgumentData) == 0x0000E8, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeStruct_FormatArgumentData_1) == 0x000138, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeArray_Array) == 0x000188, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeArray_Array_1) == 0x000198, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Format_ReturnValue) == 0x0001A8, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Format_ReturnValue_1) == 0x0001C0, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(WBP_Notice_Deathlog_C_MakeKillLogText) == 0x0001D8, "Wrong size on WBP_Notice_Deathlog_C_MakeKillLogText");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, AttackerName) == 0x000058, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, DefenderName) == 0x000070, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, Reason) == 0x000088, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::Reason' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_GetDeathResonText_ReasonText) == 0x0000A0, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_GetDeathResonText_ReasonText' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Conv_StringToText_ReturnValue) == 0x0000B8, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Conv_StringToText_ReturnValue_1) == 0x0000D0, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeStruct_FormatArgumentData) == 0x0000E8, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeStruct_FormatArgumentData_1) == 0x000138, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeArray_Array) == 0x000188, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeArray_Array_1) == 0x000198, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Format_ReturnValue) == 0x0001A8, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Format_ReturnValue_1) == 0x0001C0, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
{
public:
	struct FPalKillLogDisplayData                 DeathLogDisplayData;                               // 0x0000(0x0058)(BlueprintVisible, BlueprintReadOnly, Parm)
	class FText                                   CallFunc_MakeDeathLogText_AttackerName;            // 0x0058(0x0018)()
	class FText                                   CallFunc_MakeDeathLogText_DefenderName;            // 0x0070(0x0018)()
	class FText                                   CallFunc_MakeDeathLogText_Reason;                  // 0x0088(0x0018)()
};
...
static_assert(sizeof(WBP_Notice_Deathlog_C_SetupAsDeathLog) == 0x0000A0, "Wrong size on WBP_Notice_Deathlog_C_SetupAsDeathLog");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsDeathLog, CallFunc_MakeDeathLogText_AttackerName) == 0x000058, "Member 'WBP_Notice_Deathlog_C_SetupAsDeathLog::CallFunc_MakeDeathLogText_AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsDeathLog, CallFunc_MakeDeathLogText_DefenderName) == 0x000070, "Member 'WBP_Notice_Deathlog_C_SetupAsDeathLog::CallFunc_MakeDeathLogText_DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsDeathLog, CallFunc_MakeDeathLogText_Reason) == 0x000088, "Member 'WBP_Notice_Deathlog_C_SetupAsDeathLog::CallFunc_MakeDeathLogText_Reason' has a wrong offset!");
...
{
public:
	struct FPalKillLogDisplayData                 KillLogDIsplayData;                                // 0x0000(0x0058)(BlueprintVisible, BlueprintReadOnly, Parm)
	class FText                                   CallFunc_MakeKillLogText_AttackerName;             // 0x0058(0x0018)()
	class FText                                   CallFunc_MakeKillLogText_DefenderName;             // 0x0070(0x0018)()
	class FText                                   CallFunc_MakeKillLogText_Reason;                   // 0x0088(0x0018)()
};
...
static_assert(sizeof(WBP_Notice_Deathlog_C_SetupAsKillLog) == 0x0000A0, "Wrong size on WBP_Notice_Deathlog_C_SetupAsKillLog");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsKillLog, CallFunc_MakeKillLogText_AttackerName) == 0x000058, "Member 'WBP_Notice_Deathlog_C_SetupAsKillLog::CallFunc_MakeKillLogText_AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsKillLog, CallFunc_MakeKillLogText_DefenderName) == 0x000070, "Member 'WBP_Notice_Deathlog_C_SetupAsKillLog::CallFunc_MakeKillLogText_DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsKillLog, CallFunc_MakeKillLogText_Reason) == 0x000088, "Member 'WBP_Notice_Deathlog_C_SetupAsKillLog::CallFunc_MakeKillLogText_Reason' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3AA0[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue;      // 0x0068(0x0030)(UObjectWrapper, HasGetValueTypeHash)
	...
	uint8                                         Pad_3AA1[0x7];                                     // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalDatabaseCharacterParameter*         CallFunc_GetDatabaseCharacterParameter_ReturnValue_1; // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue_1;    // 0x00A8(0x0030)(UObjectWrapper, HasGetValueTypeHash)
};
static_assert(alignof(WBP_Notice_Deathlog_C_SetupIcon) == 0x000008, "Wrong alignment on WBP_Notice_Deathlog_C_SetupIcon");
static_assert(sizeof(WBP_Notice_Deathlog_C_SetupIcon) == 0x0000D8, "Wrong size on WBP_Notice_Deathlog_C_SetupIcon");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000058, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetDatabaseCharacterParameter_ReturnValue) == 0x000060, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetDatabaseCharacterParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetCharacterIconTexture_ReturnValue) == 0x000068, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetCharacterIconTexture_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_EqualEqual_NameName_ReturnValue_1) == 0x000098, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_EqualEqual_NameName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetDatabaseCharacterParameter_ReturnValue_1) == 0x0000A0, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetDatabaseCharacterParameter_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetCharacterIconTexture_ReturnValue_1) == 0x0000A8, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetCharacterIconTexture_ReturnValue_1' has a wrong offset!");
