...
class UWidgetAnimation* UWBP_PalWorkPowerPlant_C::GetAnimationDetailToSimple()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalWorkPowerPlant_C", "GetAnimationDetailToSimple");

	Params::WBP_PalWorkPowerPlant_C_GetAnimationDetailToSimple Parms{};
