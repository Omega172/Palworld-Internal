...
public:
	...
	uint8                                         Pad_4860[0x4];                                     // 0x02B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4861[0x7];                                     // 0x02D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ABP_ExplosionAttackBase_C) == 0x0002E8, "Wrong size on ABP_ExplosionAttackBase_C");
...
static_assert(offsetof(ABP_ExplosionAttackBase_C, IsBlow) == 0x0002D0, "Member 'ABP_ExplosionAttackBase_C::IsBlow' has a wrong offset!");
static_assert(offsetof(ABP_ExplosionAttackBase_C, Special_Attack_Rate_Infos) == 0x0002D8, "Member 'ABP_ExplosionAttackBase_C::Special_Attack_Rate_Infos' has a wrong offset!");
