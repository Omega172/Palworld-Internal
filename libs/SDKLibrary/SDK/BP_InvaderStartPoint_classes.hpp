...
static_assert(sizeof(ABP_InvaderStartPoint_C) == 0x0002C0, "Wrong size on ABP_InvaderStartPoint_C");
static_assert(offsetof(ABP_InvaderStartPoint_C, StaticMesh) == 0x0002B0, "Member 'ABP_InvaderStartPoint_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(ABP_InvaderStartPoint_C, DefaultSceneRoot) == 0x0002B8, "Member 'ABP_InvaderStartPoint_C::DefaultSceneRoot' has a wrong offset!");
