...
static_assert(offsetof(BP_SquadNPCSpawner_C_Check_Spawn, CallFunc_GetDisableBossSpawnerFlag_FromSaveData_ReturnValue) == 0x000008, "Member 'BP_SquadNPCSpawner_C_Check_Spawn::CallFunc_GetDisableBossSpawnerFlag_FromSaveData_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Check_Spawn, CallFunc_IsNearBaseCamp_ReturnValue) == 0x000009, "Member 'BP_SquadNPCSpawner_C_Check_Spawn::CallFunc_IsNearBaseCamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Check_Spawn, CallFunc_CheckSpawnDistance_ReturnValue) == 0x00000A, "Member 'BP_SquadNPCSpawner_C_Check_Spawn::CallFunc_CheckSpawnDistance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Check_Spawn, K2Node_SwitchEnum_CmpSuccess) == 0x00000B, "Member 'BP_SquadNPCSpawner_C_Check_Spawn::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_52FC[0x2];                                     // 0x0012(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_52FD[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_52FF[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5300[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5301[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner) == 0x000050, "Wrong size on BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner");
...
static_assert(offsetof(BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner, CallFunc_Array_Get_Item) == 0x000010, "Member 'BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner, CallFunc_Array_Length_ReturnValue) == 0x000018, "Member 'BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner, CallFunc_TryGetIndividualActor_ReturnValue) == 0x000020, "Member 'BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner::CallFunc_TryGetIndividualActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner, CallFunc_Less_IntInt_ReturnValue) == 0x000028, "Member 'BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000030, "Member 'BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner, CallFunc_Array_Add_ReturnValue) == 0x000048, "Member 'BP_SquadNPCSpawner_C_ExecuteUbergraph_BP_SquadNPCSpawner::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5302[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5303[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5304[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5305[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5306[0xC];                                     // 0x0094(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5307[0x4];                                     // 0x0144(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5308[0xC];                                     // 0x0164(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5309[0xB];                                     // 0x0215(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_530A[0x1];                                     // 0x02C7(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_530B[0x3];                                     // 0x02D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_530C[0x4];                                     // 0x02EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_530D[0x3];                                     // 0x02F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_530E[0x7];                                     // 0x0311(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_530F[0x4];                                     // 0x0324(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_GetCharacterIDFromCharacterIDAndUniqueNPCID_ReturnValue) == 0x000150, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_GetCharacterIDFromCharacterIDAndUniqueNPCID_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Add_ReturnValue_1) == 0x000158, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, Temp_int_Loop_Counter_Variable_1) == 0x00015C, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
...
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Length_ReturnValue_1) == 0x000210, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Less_IntInt_ReturnValue) == 0x000214, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Add_ReturnValue_2) == 0x0002C0, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Add_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Greater_IntInt_ReturnValue) == 0x0002C4, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_IsValidClass_ReturnValue) == 0x0002C5, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_IsValidClass_ReturnValue_1) == 0x0002C6, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_IsValidClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, Temp_int_Loop_Counter_Variable_2) == 0x0002C8, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::Temp_int_Loop_Counter_Variable_2' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Add_ReturnValue_3) == 0x0002CC, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Add_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Less_IntInt_ReturnValue_1) == 0x0002D0, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Add_IntInt_ReturnValue_2) == 0x0002D4, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_GetChildrenComponents_Children) == 0x0002D8, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_GetChildrenComponents_Children' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Length_ReturnValue_2) == 0x0002E8, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Get_Item_2) == 0x0002F0, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Less_IntInt_ReturnValue_2) == 0x0002F8, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Add_ReturnValue_4) == 0x0002FC, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Add_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, K2Node_DynamicCast_AsBPI_Spawn_Point_Info) == 0x000300, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::K2Node_DynamicCast_AsBPI_Spawn_Point_Info' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, K2Node_DynamicCast_bSuccess) == 0x000310, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_GetOwner_ReturnValue) == 0x000318, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, CallFunc_Array_Add_ReturnValue_5) == 0x000320, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::CallFunc_Array_Add_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, K2Node_DynamicCast_AsBPI_Spawn_Point_Info_1) == 0x000328, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::K2Node_DynamicCast_AsBPI_Spawn_Point_Info_1' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_SetupSpawnInfoList, K2Node_DynamicCast_bSuccess_1) == 0x000338, "Member 'BP_SquadNPCSpawner_C_SetupSpawnInfoList::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5310[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5311[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetInitializedCharacterSaveParemter_outParameter; // 0x0110(0x02E0)()
	...
	uint8                                         Pad_5312[0x7];                                     // 0x03F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_SquadNPCSpawner_C_Spawn) == 0x000408, "Wrong size on BP_SquadNPCSpawner_C_Spawn");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_Array_Length_ReturnValue) == 0x000000, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_Array_Length_ReturnValue_1) == 0x000004, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, Temp_int_Variable) == 0x000008, "Member 'BP_SquadNPCSpawner_C_Spawn::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x00000C, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_Add_IntInt_ReturnValue) == 0x000010, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_Array_Length_ReturnValue_2) == 0x000014, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_Subtract_IntInt_ReturnValue) == 0x000018, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_LessEqual_IntInt_ReturnValue) == 0x00001C, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_BreakTransform_Location) == 0x000020, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_BreakTransform_Rotation) == 0x000038, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_BreakTransform_Scale) == 0x000050, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, K2Node_CreateDelegate_OutputDelegate) == 0x000068, "Member 'BP_SquadNPCSpawner_C_Spawn::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_GetCharacterManager_ReturnValue) == 0x000078, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_GetCharacterManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000080, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, K2Node_MakeStruct_Guid) == 0x000088, "Member 'BP_SquadNPCSpawner_C_Spawn::K2Node_MakeStruct_Guid' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, K2Node_MakeStruct_NetworkActorSpawnParameters) == 0x000098, "Member 'BP_SquadNPCSpawner_C_Spawn::K2Node_MakeStruct_NetworkActorSpawnParameters' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_GetInitializedCharacterSaveParemter_outParameter) == 0x000110, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_GetInitializedCharacterSaveParemter_outParameter' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_GetInitializedCharacterSaveParemter_ReturnValue) == 0x0003F0, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_GetInitializedCharacterSaveParemter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_SpawnNewCharacter_ReturnValue) == 0x0003F8, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_SpawnNewCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_SquadNPCSpawner_C_Spawn, CallFunc_Array_Add_ReturnValue) == 0x000400, "Member 'BP_SquadNPCSpawner_C_Spawn::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
