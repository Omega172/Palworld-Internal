...
public:
	...
	uint8                                         Pad_6001[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6002[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_6003[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_6004[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6005[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalLogInfo_DropPal                    CallFunc_Array_Get_Item;                           // 0x0028(0x0018)()
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6006[0x3];                                     // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_6007[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPalLogInfo_DropPal>            K2Node_MakeArray_Array;                            // 0x0010(0x0010)(ReferenceParm)
...
static_assert(alignof(WBP_GameOver_Defeat_C_SetHardcoreInfo) == 0x000008, "Wrong alignment on WBP_GameOver_Defeat_C_SetHardcoreInfo");
static_assert(sizeof(WBP_GameOver_Defeat_C_SetHardcoreInfo) == 0x000048, "Wrong size on WBP_GameOver_Defeat_C_SetHardcoreInfo");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_GetLocalPlayerState_ReturnValue) == 0x000000, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_GetLocalPlayerState_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_IsInStage_ReturnValue) == 0x000008, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_IsInStage_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, K2Node_MakeArray_Array) == 0x000010, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_GetLocalizedText_ReturnValue) == 0x000020, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_GetLocalizedText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, K2Node_MakeStruct_LinearColor) == 0x000038, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::K2Node_MakeStruct_LinearColor' has a wrong offset!");
