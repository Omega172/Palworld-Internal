...
public:
	...
	uint8                                         Pad_53FC[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_53FD[0x3];                                     // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_2;            // 0x003C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_53FE[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_53FF[0x7];                                     // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor) == 0x0000D0, "Wrong size on BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor");
...
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, K2Node_Event_InitParam) == 0x000050, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::K2Node_Event_InitParam' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, K2Node_Event_PossessedPawn) == 0x000090, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::K2Node_Event_PossessedPawn' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, CallFunc_GetComponentByClass_ReturnValue) == 0x000098, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, CallFunc_IsValid_ReturnValue) == 0x0000A0, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, CallFunc_K2_GetPawn_ReturnValue) == 0x0000A8, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, K2Node_CreateDelegate_OutputDelegate_3) == 0x0000B0, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, CallFunc_GetComponentByClass_ReturnValue_1) == 0x0000C0, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::CallFunc_GetComponentByClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor, CallFunc_IsValid_ReturnValue_1) == 0x0000C8, "Member 'BP_NPCAIController_Visitor_C_ExecuteUbergraph_BP_NPCAIController_Visitor::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5400[0x2];                                     // 0x0026(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5401[0x3];                                     // 0x0065(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_NPCAIController_Visitor_C_SetupVisitorParameter) == 0x000008, "Wrong alignment on BP_NPCAIController_Visitor_C_SetupVisitorParameter");
static_assert(sizeof(BP_NPCAIController_Visitor_C_SetupVisitorParameter) == 0x000040, "Wrong size on BP_NPCAIController_Visitor_C_SetupVisitorParameter");
static_assert(offsetof(BP_NPCAIController_Visitor_C_SetupVisitorParameter, InitParam) == 0x000000, "Member 'BP_NPCAIController_Visitor_C_SetupVisitorParameter::InitParam' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5403[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp) == 0x000008, "Wrong alignment on BP_NPCAIController_Visitor_C_StartTravelToBaseCamp");
static_assert(sizeof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp) == 0x000078, "Wrong size on BP_NPCAIController_Visitor_C_StartTravelToBaseCamp");
static_assert(offsetof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp, K2Node_MakeStruct_PalAIActionDynamicParameter) == 0x000000, "Member 'BP_NPCAIController_Visitor_C_StartTravelToBaseCamp::K2Node_MakeStruct_PalAIActionDynamicParameter' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp, K2Node_DynamicCast_AsPal_AIAction_Component) == 0x000050, "Member 'BP_NPCAIController_Visitor_C_StartTravelToBaseCamp::K2Node_DynamicCast_AsPal_AIAction_Component' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'BP_NPCAIController_Visitor_C_StartTravelToBaseCamp::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp, CallFunc_SetActionClassParameter_ReturnValue) == 0x000060, "Member 'BP_NPCAIController_Visitor_C_StartTravelToBaseCamp::CallFunc_SetActionClassParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp, K2Node_DynamicCast_AsBP_AIAction_Visitor_Travel_to_Base_Camp) == 0x000068, "Member 'BP_NPCAIController_Visitor_C_StartTravelToBaseCamp::K2Node_DynamicCast_AsBP_AIAction_Visitor_Travel_to_Base_Camp' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_StartTravelToBaseCamp, K2Node_DynamicCast_bSuccess_1) == 0x000070, "Member 'BP_NPCAIController_Visitor_C_StartTravelToBaseCamp::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
static_assert(alignof(BP_NPCAIController_Visitor_C_OnDead) == 0x000008, "Wrong alignment on BP_NPCAIController_Visitor_C_OnDead");
static_assert(sizeof(BP_NPCAIController_Visitor_C_OnDead) == 0x000020, "Wrong size on BP_NPCAIController_Visitor_C_OnDead");
static_assert(offsetof(BP_NPCAIController_Visitor_C_OnDead, LastAttacker) == 0x000000, "Member 'BP_NPCAIController_Visitor_C_OnDead::LastAttacker' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_OnDead, CallFunc_K2_GetPawn_ReturnValue) == 0x000008, "Member 'BP_NPCAIController_Visitor_C_OnDead::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_OnDead, CallFunc_GetComponentByClass_ReturnValue) == 0x000010, "Member 'BP_NPCAIController_Visitor_C_OnDead::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCAIController_Visitor_C_OnDead, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'BP_NPCAIController_Visitor_C_OnDead::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(alignof(BP_NPCAIController_Visitor_C_ReceivePossess) == 0x000008, "Wrong alignment on BP_NPCAIController_Visitor_C_ReceivePossess");
static_assert(sizeof(BP_NPCAIController_Visitor_C_ReceivePossess) == 0x000008, "Wrong size on BP_NPCAIController_Visitor_C_ReceivePossess");
static_assert(offsetof(BP_NPCAIController_Visitor_C_ReceivePossess, PossessedPawn) == 0x000000, "Member 'BP_NPCAIController_Visitor_C_ReceivePossess::PossessedPawn' has a wrong offset!");
