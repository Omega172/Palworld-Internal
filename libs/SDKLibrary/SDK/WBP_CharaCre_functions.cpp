...
void UWBP_CharaCre_C::OnHoverVoiceButton(int32 VoiceID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CharaCre_C", "OnHoverVoiceButton");

	Params::WBP_CharaCre_C_OnHoverVoiceButton Parms{};
...
// Function WBP_CharaCre.WBP_CharaCre_C.OnUnhoverVoiceButton
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_CharaCre_C::OnUnhoverVoiceButton()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CharaCre_C", "OnUnhoverVoiceButton");
...
void UWBP_CharaCre_C::Request_Play_Sample_Voice(int32 VoiceID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CharaCre_C", "Request Play Sample Voice");

	Params::WBP_CharaCre_C_Request_Play_Sample_Voice Parms{};
