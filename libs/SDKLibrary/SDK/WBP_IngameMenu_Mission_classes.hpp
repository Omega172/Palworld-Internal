...
public:
	...
	uint8                                         Pad_5766[0x3];                                     // 0x0599(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5767[0x7];                                     // 0x05A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWBP_IngameMenu_Mission_C) == 0x0005C0, "Wrong size on UWBP_IngameMenu_Mission_C");
...
static_assert(offsetof(UWBP_IngameMenu_Mission_C, MissionList) == 0x0004E0, "Member 'UWBP_IngameMenu_Mission_C::MissionList' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, ChedckedData) == 0x0004F0, "Member 'UWBP_IngameMenu_Mission_C::ChedckedData' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, TaskData) == 0x000550, "Member 'UWBP_IngameMenu_Mission_C::TaskData' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, BuildOBjectNumTaskInfoMsgID) == 0x000578, "Member 'UWBP_IngameMenu_Mission_C::BuildOBjectNumTaskInfoMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, WorkerNumTaskInfoMsgID) == 0x000588, "Member 'UWBP_IngameMenu_Mission_C::WorkerNumTaskInfoMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, CanLevelup) == 0x000598, "Member 'UWBP_IngameMenu_Mission_C::CanLevelup' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, LastLevel) == 0x00059C, "Member 'UWBP_IngameMenu_Mission_C::LastLevel' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, TaskUpdateTimer) == 0x0005A0, "Member 'UWBP_IngameMenu_Mission_C::TaskUpdateTimer' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, ButtonActive) == 0x0005A8, "Member 'UWBP_IngameMenu_Mission_C::ButtonActive' has a wrong offset!");
static_assert(offsetof(UWBP_IngameMenu_Mission_C, PalLimitMsgId) == 0x0005B0, "Member 'UWBP_IngameMenu_Mission_C::PalLimitMsgId' has a wrong offset!");
