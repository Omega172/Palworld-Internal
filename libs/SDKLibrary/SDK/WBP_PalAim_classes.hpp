...
public:
	...
	uint8                                         Pad_6144[0x7];                                     // 0x0459(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetGrapplingReticleVisible(bool Param_IsVisible);
...
static_assert(sizeof(UWBP_PalAim_C) == 0x000468, "Wrong size on UWBP_PalAim_C");
