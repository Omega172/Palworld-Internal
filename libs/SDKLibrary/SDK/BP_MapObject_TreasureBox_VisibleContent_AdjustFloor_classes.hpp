...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_MapObject_TreasureBox_VisibleContent_AdjustFloor_C; // 0x0420(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABP_MapObject_TreasureBox_VisibleContent_AdjustFloor_C) == 0x000428, "Wrong size on ABP_MapObject_TreasureBox_VisibleContent_AdjustFloor_C");
static_assert(offsetof(ABP_MapObject_TreasureBox_VisibleContent_AdjustFloor_C, UberGraphFrame_BP_MapObject_TreasureBox_VisibleContent_AdjustFloor_C) == 0x000420, "Member 'ABP_MapObject_TreasureBox_VisibleContent_AdjustFloor_C::UberGraphFrame_BP_MapObject_TreasureBox_VisibleContent_AdjustFloor_C' has a wrong offset!");
