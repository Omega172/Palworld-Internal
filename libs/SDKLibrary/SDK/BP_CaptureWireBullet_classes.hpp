...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_CaptureWireBullet_C;             // 0x03A0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	uint8                                         Pad_5AD8[0x7];                                     // 0x03B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ABP_CaptureWireBullet_C) == 0x0003D8, "Wrong size on ABP_CaptureWireBullet_C");
static_assert(offsetof(ABP_CaptureWireBullet_C, UberGraphFrame_BP_CaptureWireBullet_C) == 0x0003A0, "Member 'ABP_CaptureWireBullet_C::UberGraphFrame_BP_CaptureWireBullet_C' has a wrong offset!");
static_assert(offsetof(ABP_CaptureWireBullet_C, StaticMesh) == 0x0003A8, "Member 'ABP_CaptureWireBullet_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(ABP_CaptureWireBullet_C, CaptureTarget) == 0x0003B0, "Member 'ABP_CaptureWireBullet_C::CaptureTarget' has a wrong offset!");
static_assert(offsetof(ABP_CaptureWireBullet_C, IsBound) == 0x0003B8, "Member 'ABP_CaptureWireBullet_C::IsBound' has a wrong offset!");
static_assert(offsetof(ABP_CaptureWireBullet_C, ThrowRotator) == 0x0003C0, "Member 'ABP_CaptureWireBullet_C::ThrowRotator' has a wrong offset!");
