...
public:
	...
	EPalWazaID                                    BindedWazaID;                                      // 0x0308(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3B5F[0x7];                                     // 0x0309(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWBP_MainMenu_Pal_Skill_Active_C) == 0x000380, "Wrong size on UWBP_MainMenu_Pal_Skill_Active_C");
...
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, SkillBase) == 0x0002C0, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::SkillBase' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, Text_WazaName) == 0x0002C8, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::Text_WazaName' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, Text_WazaPower) == 0x0002D0, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::Text_WazaPower' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, WBP_MainMenu_Cursor) == 0x0002D8, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::WBP_MainMenu_Cursor' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, WBP_PalInvisibleButton) == 0x0002E0, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::WBP_PalInvisibleButton' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, OnHovered) == 0x0002E8, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::OnHovered' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, OnUnhovered) == 0x0002F8, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::OnUnhovered' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, BindedWazaID) == 0x000308, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::BindedWazaID' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, OnClicked) == 0x000310, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::OnClicked' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, ElementTextureMap) == 0x000320, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::ElementTextureMap' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Pal_Skill_Active_C, EmptySlotMsgID) == 0x000370, "Member 'UWBP_MainMenu_Pal_Skill_Active_C::EmptySlotMsgID' has a wrong offset!");
