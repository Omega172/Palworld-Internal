...
public:
	...
	uint8                                         Pad_3C91[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_CharaCre_C_ExecuteUbergraph_WBP_CharaCre) == 0x000088, "Wrong size on WBP_CharaCre_C_ExecuteUbergraph_WBP_CharaCre");
...
static_assert(offsetof(WBP_CharaCre_C_ExecuteUbergraph_WBP_CharaCre, CallFunc_GetPalGameInstance_ReturnValue) == 0x000078, "Member 'WBP_CharaCre_C_ExecuteUbergraph_WBP_CharaCre::CallFunc_GetPalGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_C_ExecuteUbergraph_WBP_CharaCre, CallFunc_IsChatDisabled_ReturnValue) == 0x000080, "Member 'WBP_CharaCre_C_ExecuteUbergraph_WBP_CharaCre::CallFunc_IsChatDisabled_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3C94[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	E_UICharacterMakeCategory                     NewCategory;                                       // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3C96[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWidget*                                Widget;                                            // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(WBP_CharaCre_C_OnHoverVoiceButton) == 0x000004, "Wrong alignment on WBP_CharaCre_C_OnHoverVoiceButton");
static_assert(sizeof(WBP_CharaCre_C_OnHoverVoiceButton) == 0x000004, "Wrong size on WBP_CharaCre_C_OnHoverVoiceButton");
static_assert(offsetof(WBP_CharaCre_C_OnHoverVoiceButton, VoiceID) == 0x000000, "Member 'WBP_CharaCre_C_OnHoverVoiceButton::VoiceID' has a wrong offset!");
...
static_assert(alignof(WBP_CharaCre_C_Request_Play_Sample_Voice) == 0x000004, "Wrong alignment on WBP_CharaCre_C_Request_Play_Sample_Voice");
static_assert(sizeof(WBP_CharaCre_C_Request_Play_Sample_Voice) == 0x000008, "Wrong size on WBP_CharaCre_C_Request_Play_Sample_Voice");
static_assert(offsetof(WBP_CharaCre_C_Request_Play_Sample_Voice, VoiceID) == 0x000000, "Member 'WBP_CharaCre_C_Request_Play_Sample_Voice::VoiceID' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_C_Request_Play_Sample_Voice, CallFunc_Less_IntInt_ReturnValue) == 0x000004, "Member 'WBP_CharaCre_C_Request_Play_Sample_Voice::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_CharaCre_C_Setup) == 0x0000F0, "Wrong size on WBP_CharaCre_C_Setup");
...
static_assert(offsetof(WBP_CharaCre_C_Setup, K2Node_CreateDelegate_OutputDelegate_13) == 0x0000D0, "Member 'WBP_CharaCre_C_Setup::K2Node_CreateDelegate_OutputDelegate_13' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_C_Setup, K2Node_CreateDelegate_OutputDelegate_14) == 0x0000E0, "Member 'WBP_CharaCre_C_Setup::K2Node_CreateDelegate_OutputDelegate_14' has a wrong offset!");
