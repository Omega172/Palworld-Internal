...
public:
	...
	uint8                                         Pad_1A04[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1A06[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class AActor*                                 CallFunc_FindNearestAttackTarget_ReturnValue;      // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1A07[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_FindClosestActorToReticle_ReturnValue;    // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy) == 0x000008, "Wrong alignment on BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy");
static_assert(sizeof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy) == 0x000070, "Wrong size on BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, Target) == 0x000000, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::Target' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, Player) == 0x000008, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::Player' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_IsSameTargetAsTrainerCommand_ReturnValue) == 0x000010, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_IsSameTargetAsTrainerCommand_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_GetBattleManager_ReturnValue) == 0x000018, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_GetBattleManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_GetController_ReturnValue) == 0x000020, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_GetConflictEnemies_OutEnemyes) == 0x000028, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_GetConflictEnemies_OutEnemyes' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_GetConflictEnemies_ReturnValue) == 0x000038, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_GetConflictEnemies_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_K2_GetPawn_ReturnValue) == 0x000040, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_GetTrainerPlayer_ReturnValue) == 0x000048, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_GetTrainerPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_FindNearestAttackTarget_ReturnValue) == 0x000050, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_FindNearestAttackTarget_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_IsValid_ReturnValue) == 0x000058, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_FindClosestActorToReticle_ReturnValue) == 0x000060, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_FindClosestActorToReticle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_IsValid_ReturnValue_1) == 0x000068, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(BP_AIAction_OtomoDefault_C_SetActionCombat) == 0x000050, "Wrong size on BP_AIAction_OtomoDefault_C_SetActionCombat");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, CallFunc_FindTrainerBattleEnemy_Target) == 0x000000, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::CallFunc_FindTrainerBattleEnemy_Target' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, CallFunc_GetController_ReturnValue) == 0x000008, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, CallFunc_GetController_ReturnValue_1) == 0x000010, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::CallFunc_GetController_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, K2Node_DynamicCast_AsBP_Monster_AIController_Otomo) == 0x000018, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::K2Node_DynamicCast_AsBP_Monster_AIController_Otomo' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, CallFunc_K2_GetPawn_ReturnValue) == 0x000028, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, CallFunc_Set_Combat_Action_And_Target_AIAction) == 0x000030, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::CallFunc_Set_Combat_Action_And_Target_AIAction' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, CallFunc_GetMovementComponent_ReturnValue) == 0x000038, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::CallFunc_GetMovementComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, K2Node_DynamicCast_AsPal_Character_Movement_Component) == 0x000040, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::K2Node_DynamicCast_AsPal_Character_Movement_Component' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_SetActionCombat, K2Node_DynamicCast_bSuccess_1) == 0x000048, "Member 'BP_AIAction_OtomoDefault_C_SetActionCombat::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
...
public:
	...
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1A0A[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APawn*                                  CallFunc_K2_GetPawn_ReturnValue;                   // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_1A0B[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
