...
void ABP_OilRigCannon_LaserTower_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_OilRigCannon_LaserTower_C", "ReceiveEndPlay");

	Params::BP_OilRigCannon_LaserTower_C_ReceiveEndPlay Parms{};
