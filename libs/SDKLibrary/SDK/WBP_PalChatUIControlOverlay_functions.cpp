...
// Function WBP_PalChatUIControlOverlay.WBP_PalChatUIControlOverlay_C.OnCancel_ForceClose
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_PalChatUIControlOverlay_C::OnCancel_ForceClose()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalChatUIControlOverlay_C", "OnCancel_ForceClose");
