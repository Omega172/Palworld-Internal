...
static_assert(alignof(BP_GrapplingGun_Bullet_C_AttachSocket) == 0x000008, "Wrong alignment on BP_GrapplingGun_Bullet_C_AttachSocket");
static_assert(sizeof(BP_GrapplingGun_Bullet_C_AttachSocket) == 0x000010, "Wrong size on BP_GrapplingGun_Bullet_C_AttachSocket");
static_assert(offsetof(BP_GrapplingGun_Bullet_C_AttachSocket, Component) == 0x000000, "Member 'BP_GrapplingGun_Bullet_C_AttachSocket::Component' has a wrong offset!");
static_assert(offsetof(BP_GrapplingGun_Bullet_C_AttachSocket, SocketName) == 0x000008, "Member 'BP_GrapplingGun_Bullet_C_AttachSocket::SocketName' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5C50[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_GrapplingGun_Bullet_C_UpdateCable) == 0x000008, "Wrong alignment on BP_GrapplingGun_Bullet_C_UpdateCable");
static_assert(sizeof(BP_GrapplingGun_Bullet_C_UpdateCable) == 0x000140, "Wrong size on BP_GrapplingGun_Bullet_C_UpdateCable");
