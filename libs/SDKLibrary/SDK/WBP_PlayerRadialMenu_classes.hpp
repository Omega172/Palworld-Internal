...
public:
	...
	uint8                                         Pad_43D6[0x3];                                     // 0x0429(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_43D7[0x3];                                     // 0x0435(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FDataTableRowHandle                    EmoteMsgID_8;                                      // 0x0558(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    SlaughterMsgID;                                    // 0x0568(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	FMulticastInlineDelegateProperty_             OnRequestOpenChat;                                 // 0x0578(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FDataTableRowHandle                    OpenChatMsgID;                                     // 0x0588(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(sizeof(UWBP_PlayerRadialMenu_C) == 0x000598, "Wrong size on UWBP_PlayerRadialMenu_C");
...
static_assert(offsetof(UWBP_PlayerRadialMenu_C, EmoteMsgID_8) == 0x000558, "Member 'UWBP_PlayerRadialMenu_C::EmoteMsgID_8' has a wrong offset!");
static_assert(offsetof(UWBP_PlayerRadialMenu_C, SlaughterMsgID) == 0x000568, "Member 'UWBP_PlayerRadialMenu_C::SlaughterMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_PlayerRadialMenu_C, OnRequestOpenChat) == 0x000578, "Member 'UWBP_PlayerRadialMenu_C::OnRequestOpenChat' has a wrong offset!");
static_assert(offsetof(UWBP_PlayerRadialMenu_C, OpenChatMsgID) == 0x000588, "Member 'UWBP_PlayerRadialMenu_C::OpenChatMsgID' has a wrong offset!");
