...
public:
	...
	struct FVector                                Min_Land_Scape_Position;                           // 0x04B0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                Max_Land_Scape_Position;                           // 0x04C8(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TMap<struct FGuid, class UWBP_WorldMap_IconBase_NoDesign_C*> CreatedIconMap;                                    // 0x04E0(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TMap<struct FGuid, class UWBP_Map_IconCustom_C*> CustomMarkerMap;                                   // 0x0530(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TMap<class UPalLocationPoint*, struct FGuid>  DeathMarkMap;                                      // 0x0580(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class UWBP_Map_IconDeath_C*>           DeathMarks;                                        // 0x05D0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TArray<class UWBP_Map_IconTower_C*>           BossTowerIcons;                                    // 0x05E0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	bool                                          CustomMarkMode;                                    // 0x05F0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          FilterOpened;                                      // 0x05F1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5F82[0x6];                                     // 0x05F2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_WorldMap_IconBase_NoDesign_C*      CurrentSetupIcon;                                  // 0x05F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          For_Respawn;                                       // 0x0600(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5F83[0x7];                                     // 0x0601(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UWBP_Map_IconPlayer_C*>          PlayerIcons;                                       // 0x0608(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	bool                                          Can_Fast_Travel;                                   // 0x0618(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsInitSelect;                                      // 0x0619(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5F84[0x6];                                     // 0x061A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<EPalLocationType>                        FilterIconTypes;                                   // 0x0620(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FDataTableRowHandle                    FTMsgID;                                           // 0x0670(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    RespawnMsgID;                                      // 0x0680(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	TArray<class UWBP_Map_IconBoss_C*>            BossIcons;                                         // 0x0690(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	class FName                                   DismantalActionName;                               // 0x06A0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FDataTableRowHandle                    InitSelectMsgID;                                   // 0x06A8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(sizeof(UWBP_Map_Base_C) == 0x0006B8, "Wrong size on UWBP_Map_Base_C");
...
static_assert(offsetof(UWBP_Map_Base_C, Min_Land_Scape_Position) == 0x0004B0, "Member 'UWBP_Map_Base_C::Min_Land_Scape_Position' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, Max_Land_Scape_Position) == 0x0004C8, "Member 'UWBP_Map_Base_C::Max_Land_Scape_Position' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, CreatedIconMap) == 0x0004E0, "Member 'UWBP_Map_Base_C::CreatedIconMap' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, CustomMarkerMap) == 0x000530, "Member 'UWBP_Map_Base_C::CustomMarkerMap' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, DeathMarkMap) == 0x000580, "Member 'UWBP_Map_Base_C::DeathMarkMap' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, DeathMarks) == 0x0005D0, "Member 'UWBP_Map_Base_C::DeathMarks' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, BossTowerIcons) == 0x0005E0, "Member 'UWBP_Map_Base_C::BossTowerIcons' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, CustomMarkMode) == 0x0005F0, "Member 'UWBP_Map_Base_C::CustomMarkMode' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, FilterOpened) == 0x0005F1, "Member 'UWBP_Map_Base_C::FilterOpened' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, CurrentSetupIcon) == 0x0005F8, "Member 'UWBP_Map_Base_C::CurrentSetupIcon' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, For_Respawn) == 0x000600, "Member 'UWBP_Map_Base_C::For_Respawn' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, PlayerIcons) == 0x000608, "Member 'UWBP_Map_Base_C::PlayerIcons' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, Can_Fast_Travel) == 0x000618, "Member 'UWBP_Map_Base_C::Can_Fast_Travel' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, IsInitSelect) == 0x000619, "Member 'UWBP_Map_Base_C::IsInitSelect' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, FilterIconTypes) == 0x000620, "Member 'UWBP_Map_Base_C::FilterIconTypes' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, FTMsgID) == 0x000670, "Member 'UWBP_Map_Base_C::FTMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, RespawnMsgID) == 0x000680, "Member 'UWBP_Map_Base_C::RespawnMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, BossIcons) == 0x000690, "Member 'UWBP_Map_Base_C::BossIcons' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, DismantalActionName) == 0x0006A0, "Member 'UWBP_Map_Base_C::DismantalActionName' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, InitSelectMsgID) == 0x0006A8, "Member 'UWBP_Map_Base_C::InitSelectMsgID' has a wrong offset!");
