...
// struct FGuid                            GuildNameModifierPlayerUId                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FFixedPoint64                    NowSh                                                  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
// struct FFixedPoint64                    MaxSh                                                  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)

void UWBP_GuildGauge_C::SetShield(const struct FFixedPoint64& NowSh, const struct FFixedPoint64& MaxSh)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GuildGauge_C", "SetShield");

	Params::WBP_GuildGauge_C_SetShield Parms{};
