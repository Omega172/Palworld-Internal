...
public:
	...
	uint8                                         Pad_404E[0x5];                                     // 0x018B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4050[0x2];                                     // 0x01D2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4051[0x4];                                     // 0x0204(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           CustomFunctionNames;                               // 0x0208(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)

public:
	void AchivementReward(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	...
	void CheckBossDefeat(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	void CheckDisplayPal(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	void CheckEmote(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	void CheckPalCapture(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	void CheckPalDex(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	void CircumItemRequest(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	void CircumItemTrade(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	void CreateCamera();
	...
	void GetValidItemRequestIndex(const TMap<class FName, bool>& RecordMap, TArray<struct FPalCircumRequestData>& RequestData, EPalItemRequireCategory RequestCategory, const TMap<class FString, int32>& CircumCountMap, int32* Param_Index, bool* EnalbeExpBonus);
	void GetValidPalDisplayIndex(const TMap<class FName, bool>& RecordMap, TArray<struct FPalDisplayRequestData>& RewardData, EPalPalDisplayCategory RequestCategory, int32* Param_Index);
	void GetValidRewardCountIndex(const TMap<class FName, bool>& RecordMap, TArray<struct FPalRecordCountRewardData>& RewardData, int32* Param_Index);
	...
	void Open_Item_Shop_Buy(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
	...
	void PalDisplayRequest(const struct FPalNPCTalkSystemCustomFunctionParameters& Param);
...
static_assert(offsetof(UBP_PalIncidentNPCTalk_C, IsRecruiting) == 0x00018A, "Member 'UBP_PalIncidentNPCTalk_C::IsRecruiting' has a wrong offset!");
