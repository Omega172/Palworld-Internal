...
public:
	...
	uint8                                         Pad_5EDA[0x7];                                     // 0x0359(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ABP_PalMonsterCaptureSet_C) == 0x000418, "Wrong size on ABP_PalMonsterCaptureSet_C");
...
static_assert(offsetof(ABP_PalMonsterCaptureSet_C, LoadedCharacterClass) == 0x000410, "Member 'ABP_PalMonsterCaptureSet_C::LoadedCharacterClass' has a wrong offset!");
