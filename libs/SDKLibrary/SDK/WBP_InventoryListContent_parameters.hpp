...
static_assert(sizeof(WBP_InventoryListContent_C_AddWidget) == 0x000020, "Wrong size on WBP_InventoryListContent_C_AddWidget");
...
static_assert(offsetof(WBP_InventoryListContent_C_AddWidget, Param_Index) == 0x000008, "Member 'WBP_InventoryListContent_C_AddWidget::Param_Index' has a wrong offset!");
static_assert(offsetof(WBP_InventoryListContent_C_AddWidget, CallFunc_AddChildToWrapBox_ReturnValue) == 0x000010, "Member 'WBP_InventoryListContent_C_AddWidget::CallFunc_AddChildToWrapBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InventoryListContent_C_AddWidget, CallFunc_GetChildIndex_ReturnValue) == 0x000018, "Member 'WBP_InventoryListContent_C_AddWidget::CallFunc_GetChildIndex_ReturnValue' has a wrong offset!");
