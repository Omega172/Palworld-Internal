...
public:
	...
	uint8                                         Pad_4C75[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C76[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C77[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C78[0x6];                                     // 0x00BA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C79[0x4];                                     // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4C7C[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C7D[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_Status_Freeze_C_SetFlag) == 0x000070, "Wrong size on BP_Status_Freeze_C_SetFlag");
...
static_assert(offsetof(BP_Status_Freeze_C_SetFlag, K2Node_DynamicCast_AsPal_Character) == 0x000058, "Member 'BP_Status_Freeze_C_SetFlag::K2Node_DynamicCast_AsPal_Character' has a wrong offset!");
static_assert(offsetof(BP_Status_Freeze_C_SetFlag, K2Node_DynamicCast_bSuccess) == 0x000060, "Member 'BP_Status_Freeze_C_SetFlag::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Status_Freeze_C_SetFlag, CallFunc_GetCurrentMontage_ReturnValue) == 0x000068, "Member 'BP_Status_Freeze_C_SetFlag::CallFunc_GetCurrentMontage_ReturnValue' has a wrong offset!");
