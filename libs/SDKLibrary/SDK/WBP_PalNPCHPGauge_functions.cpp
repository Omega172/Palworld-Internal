...
void UWBP_PalNPCHPGauge_C::OnUISettingaChanged(const struct FPalOptionUISettings& PrevSettings, const struct FPalOptionUISettings& NewSettings)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalNPCHPGauge_C", "OnUISettingaChanged");

	Params::WBP_PalNPCHPGauge_C_OnUISettingaChanged Parms{};
