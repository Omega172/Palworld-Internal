...
public:
	...
	class UBP_PalTextBlock_C*                     Text_RequirePointNum;                              // 0x04A0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_MainMenu_NewDot_C*                 WBP_MainMenu_NewDot;                               // 0x04A8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	struct FPalDataTableRowName_RecipeTechnologyData Technology;                                        // 0x04B8(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash)
	FMulticastInlineDelegateProperty_             OnHoveredButton;                                   // 0x04C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnUnhoveredButton;                                 // 0x04D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnClickedButton;                                   // 0x04E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	bool                                          IsFocused;                                         // 0x04F0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5E3B[0x7];                                     // 0x04F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDataTableRowHandle                    UnlockBuildObjectInfoMsgId;                        // 0x04F8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    UnlockRecipeInfoMsgId;                             // 0x0508(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    MaskUnknownMsgId;                                  // 0x0518(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	class FName                                   BindedTechnologyName;                              // 0x0528(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          ShouldMask;                                        // 0x0530(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Is_Boss_Technology;                                // 0x0531(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5E3C[0x6];                                     // 0x0532(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDataTableRowHandle                    BuildingMsgId;                                     // 0x0538(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    ItemMsgId;                                         // 0x0548(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(sizeof(UWBP_MainMenu_Technology_Content_C) == 0x000558, "Wrong size on UWBP_MainMenu_Technology_Content_C");
...
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, Text_RequirePointNum) == 0x0004A0, "Member 'UWBP_MainMenu_Technology_Content_C::Text_RequirePointNum' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, WBP_MainMenu_NewDot) == 0x0004A8, "Member 'UWBP_MainMenu_Technology_Content_C::WBP_MainMenu_NewDot' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, WBP_PalInvisibleButton) == 0x0004B0, "Member 'UWBP_MainMenu_Technology_Content_C::WBP_PalInvisibleButton' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, Technology) == 0x0004B8, "Member 'UWBP_MainMenu_Technology_Content_C::Technology' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, OnHoveredButton) == 0x0004C0, "Member 'UWBP_MainMenu_Technology_Content_C::OnHoveredButton' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, OnUnhoveredButton) == 0x0004D0, "Member 'UWBP_MainMenu_Technology_Content_C::OnUnhoveredButton' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, OnClickedButton) == 0x0004E0, "Member 'UWBP_MainMenu_Technology_Content_C::OnClickedButton' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, IsFocused) == 0x0004F0, "Member 'UWBP_MainMenu_Technology_Content_C::IsFocused' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, UnlockBuildObjectInfoMsgId) == 0x0004F8, "Member 'UWBP_MainMenu_Technology_Content_C::UnlockBuildObjectInfoMsgId' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, UnlockRecipeInfoMsgId) == 0x000508, "Member 'UWBP_MainMenu_Technology_Content_C::UnlockRecipeInfoMsgId' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, MaskUnknownMsgId) == 0x000518, "Member 'UWBP_MainMenu_Technology_Content_C::MaskUnknownMsgId' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, BindedTechnologyName) == 0x000528, "Member 'UWBP_MainMenu_Technology_Content_C::BindedTechnologyName' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, ShouldMask) == 0x000530, "Member 'UWBP_MainMenu_Technology_Content_C::ShouldMask' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, Is_Boss_Technology) == 0x000531, "Member 'UWBP_MainMenu_Technology_Content_C::Is_Boss_Technology' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, BuildingMsgId) == 0x000538, "Member 'UWBP_MainMenu_Technology_Content_C::BuildingMsgId' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, ItemMsgId) == 0x000548, "Member 'UWBP_MainMenu_Technology_Content_C::ItemMsgId' has a wrong offset!");
