...
// Parameters:
// EPalUICommonWarningType                 Param_Display_Type                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_CommonWarning_C::GetDisplayType(EPalUICommonWarningType* Param_Display_Type)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_Display_Type != nullptr)
		*Param_Display_Type = Parms.Param_Display_Type;
}
...
void UWBP_CommonWarning_C::OnWarningClear__DelegateSignature(EPalUICommonWarningType WarningType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CommonWarning_C", "OnWarningClear__DelegateSignature");

	Params::WBP_CommonWarning_C_OnWarningClear__DelegateSignature Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FPalUICommonWarningDisplayData   WarningData                                            (BlueprintVisible, BlueprintReadOnly, Parm)
