...
public:
	...
	uint8                                         Pad_4C2E[0x7];                                     // 0x02C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C2F[0x7];                                     // 0x0301(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWBP_CommonButton_C) == 0x000320, "Wrong size on UWBP_CommonButton_C");
...
static_assert(offsetof(UWBP_CommonButton_C, OnClicked) == 0x0002B8, "Member 'UWBP_CommonButton_C::OnClicked' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, Is_First_Focus_Target) == 0x0002C8, "Member 'UWBP_CommonButton_C::Is_First_Focus_Target' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, OnHovered) == 0x0002D0, "Member 'UWBP_CommonButton_C::OnHovered' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, OnUnhovered) == 0x0002E0, "Member 'UWBP_CommonButton_C::OnUnhovered' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, InitializeMsgID) == 0x0002F0, "Member 'UWBP_CommonButton_C::InitializeMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, OverrideHover) == 0x000300, "Member 'UWBP_CommonButton_C::OverrideHover' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, WWiseHoverAudio) == 0x000308, "Member 'UWBP_CommonButton_C::WWiseHoverAudio' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, UnhoverAKAudioEvent) == 0x000310, "Member 'UWBP_CommonButton_C::UnhoverAKAudioEvent' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_C, ClickAKAudioEvent) == 0x000318, "Member 'UWBP_CommonButton_C::ClickAKAudioEvent' has a wrong offset!");
