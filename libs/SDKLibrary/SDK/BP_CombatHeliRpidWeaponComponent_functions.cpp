...
void UBP_CombatHeliRpidWeaponComponent_C::GetMuzzleFlashEffect(class UNiagaraSystem** Effect)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CombatHeliRpidWeaponComponent_C", "GetMuzzleFlashEffect");

	Params::BP_CombatHeliRpidWeaponComponent_C_GetMuzzleFlashEffect Parms{};
...
// Parameters:
// class UMeshComponent*                   Param_GunMesh                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UBP_CombatHeliRpidWeaponComponent_C::SetGunMesh(class UMeshComponent* Param_GunMesh)
{
	static class UFunction* Func = nullptr;
