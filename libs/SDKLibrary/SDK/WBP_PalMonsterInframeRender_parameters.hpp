...
public:
	...
	uint8                                         Pad_255E[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0008(0x0040)(IsPlainOldData, NoDestructor)
	float                                         K2Node_Event_InDeltaTime;                          // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_255F[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2560[0x6];                                     // 0x005A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2561[0x7];                                     // 0x0169(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2562[0x8];                                     // 0x0188(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2563[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2565[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2567[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2568[0x3];                                     // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2569[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin) == 0x000008, "Wrong alignment on WBP_PalMonsterInframeRender_C_RequestCaptureSkin");
static_assert(sizeof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin) == 0x000058, "Wrong size on WBP_PalMonsterInframeRender_C_RequestCaptureSkin");
static_assert(offsetof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin, CharacterID) == 0x000000, "Member 'WBP_PalMonsterInframeRender_C_RequestCaptureSkin::CharacterID' has a wrong offset!");
static_assert(offsetof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin, SkinName) == 0x000008, "Member 'WBP_PalMonsterInframeRender_C_RequestCaptureSkin::SkinName' has a wrong offset!");
static_assert(offsetof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin, CallFunc_GetSkinManager_ReturnValue) == 0x000010, "Member 'WBP_PalMonsterInframeRender_C_RequestCaptureSkin::CallFunc_GetSkinManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'WBP_PalMonsterInframeRender_C_RequestCaptureSkin::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin, CallFunc_GetPalCharacterClass_OutCharacterClass) == 0x000020, "Member 'WBP_PalMonsterInframeRender_C_RequestCaptureSkin::CallFunc_GetPalCharacterClass_OutCharacterClass' has a wrong offset!");
static_assert(offsetof(WBP_PalMonsterInframeRender_C_RequestCaptureSkin, CallFunc_GetPalCharacterClass_ReturnValue) == 0x000050, "Member 'WBP_PalMonsterInframeRender_C_RequestCaptureSkin::CallFunc_GetPalCharacterClass_ReturnValue' has a wrong offset!");
