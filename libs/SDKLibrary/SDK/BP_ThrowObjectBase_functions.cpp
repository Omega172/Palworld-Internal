...
void ABP_ThrowObjectBase_C::CacheDefaultGravity()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ThrowObjectBase_C", "CacheDefaultGravity");
...
void ABP_ThrowObjectBase_C::OnHit(class UPrimitiveComponent* HitComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ThrowObjectBase_C", "OnHit");

	Params::BP_ThrowObjectBase_C_OnHit Parms{};
