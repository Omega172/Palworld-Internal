...
public:
	...
	class UBP_PalTextBlock_C*                     Text_Lv;                                           // 0x02C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	...
	void SetBossInfo(bool IsDefeated, const class FName& CharacterID, int32 Level, class FName SpawnerID);
...
static_assert(offsetof(UWBP_MapPoint_Info_C, Text_Lv) == 0x0002C0, "Member 'UWBP_MapPoint_Info_C::Text_Lv' has a wrong offset!");
