...
class UWidget* UWBP_MainMenu_Technology_SortSettingWindow_C::Custom_Navigation_Up(EUINavigation Param_Navigation)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TSet<EPalItemTypeA>                     NewItemFilter                                          (BlueprintVisible, BlueprintReadOnly, Parm)
// TSet<EPalBuildObjectTypeA>              NewBuildFilter                                         (BlueprintVisible, BlueprintReadOnly, Parm)
...
void UWBP_MainMenu_Technology_SortSettingWindow_C::OnFilterChanged__DelegateSignature(const TSet<EPalItemTypeA>& NewItemFilter, const TSet<EPalBuildObjectTypeA>& NewBuildFilter, bool ShowUnlocked)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Technology_SortSettingWindow_C", "OnFilterChanged__DelegateSignature");

	Params::WBP_MainMenu_Technology_SortSettingWindow_C_OnFilterChanged__DelegateSignature Parms{};

	Parms.NewItemFilter = std::move(NewItemFilter);
	Parms.NewBuildFilter = std::move(NewBuildFilter);
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// TSet<EPalItemTypeA>                     NowItemFilter                                          (BlueprintVisible, BlueprintReadOnly, Parm)
// TSet<EPalBuildObjectTypeA>              NowBuildFilter                                         (BlueprintVisible, BlueprintReadOnly, Parm)
