...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_OtomoPalHolderComponentForNPC_C; // 0x0190(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UBP_OtomoPalHolderComponentForNPC_C) == 0x000198, "Wrong size on UBP_OtomoPalHolderComponentForNPC_C");
static_assert(offsetof(UBP_OtomoPalHolderComponentForNPC_C, UberGraphFrame_BP_OtomoPalHolderComponentForNPC_C) == 0x000190, "Member 'UBP_OtomoPalHolderComponentForNPC_C::UberGraphFrame_BP_OtomoPalHolderComponentForNPC_C' has a wrong offset!");
