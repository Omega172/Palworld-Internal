...
static_assert(alignof(BP_ThrowObjectBase_C_CacheDefaultGravity) == 0x000008, "Wrong alignment on BP_ThrowObjectBase_C_CacheDefaultGravity");
static_assert(sizeof(BP_ThrowObjectBase_C_CacheDefaultGravity) == 0x000008, "Wrong size on BP_ThrowObjectBase_C_CacheDefaultGravity");
static_assert(offsetof(BP_ThrowObjectBase_C_CacheDefaultGravity, K2Node_VariableSet_DefaultGravityScale_ImplicitCast) == 0x000000, "Member 'BP_ThrowObjectBase_C_CacheDefaultGravity::K2Node_VariableSet_DefaultGravityScale_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_46AB[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrimitiveComponent*                    K2Node_Event_HitComp_1;                            // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_OtherActor_2;                         // 0x0030(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_Event_Hit_1;                                // 0x0058(0x00E8)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class UPrimitiveComponent*                    K2Node_Event_HitComp;                              // 0x0190(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_Event_Hit;                                  // 0x01A8(0x00E8)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
static_assert(sizeof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase) == 0x0002A0, "Wrong size on BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase");
...
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_HitComp_1) == 0x000028, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_HitComp_1' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_OtherActor_2) == 0x000030, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_OtherActor_2' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_OtherComp_1) == 0x000038, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_OtherComp_1' has a wrong offset!");
...
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_Hit_1) == 0x000058, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_Hit_1' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_OtherActor_1) == 0x000140, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_OtherActor_1' has a wrong offset!");
...
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_HitComp) == 0x000190, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_HitComp' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_OtherActor) == 0x000198, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_OtherActor' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_OtherComp) == 0x0001A0, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_OtherComp' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_Event_Hit) == 0x0001A8, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_Event_Hit' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast) == 0x000290, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_VariableSet_ProjectileGravityScale_ImplicitCast) == 0x000294, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_VariableSet_ProjectileGravityScale_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase, K2Node_VariableSet_ProjectileGravityScale_ImplicitCast_1) == 0x000298, "Member 'BP_ThrowObjectBase_C_ExecuteUbergraph_BP_ThrowObjectBase::K2Node_VariableSet_ProjectileGravityScale_ImplicitCast_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_46AD[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_ThrowObjectBase_C_OnHit) == 0x000008, "Wrong alignment on BP_ThrowObjectBase_C_OnHit");
static_assert(sizeof(BP_ThrowObjectBase_C_OnHit) == 0x000100, "Wrong size on BP_ThrowObjectBase_C_OnHit");
static_assert(offsetof(BP_ThrowObjectBase_C_OnHit, HitComp) == 0x000000, "Member 'BP_ThrowObjectBase_C_OnHit::HitComp' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_OnHit, OtherActor) == 0x000008, "Member 'BP_ThrowObjectBase_C_OnHit::OtherActor' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_OnHit, OtherComp) == 0x000010, "Member 'BP_ThrowObjectBase_C_OnHit::OtherComp' has a wrong offset!");
static_assert(offsetof(BP_ThrowObjectBase_C_OnHit, Hit) == 0x000018, "Member 'BP_ThrowObjectBase_C_OnHit::Hit' has a wrong offset!");
