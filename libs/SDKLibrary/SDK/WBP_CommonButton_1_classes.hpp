...
public:
	...
	uint8                                         Pad_5A1C[0x7];                                     // 0x02C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5A1D[0x7];                                     // 0x02F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWBP_CommonButton_1_C) == 0x000318, "Wrong size on UWBP_CommonButton_1_C");
...
static_assert(offsetof(UWBP_CommonButton_1_C, IconSlot) == 0x000298, "Member 'UWBP_CommonButton_1_C::IconSlot' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, Text_Main) == 0x0002A0, "Member 'UWBP_CommonButton_1_C::Text_Main' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, WBP_PalInvisibleButton) == 0x0002A8, "Member 'UWBP_CommonButton_1_C::WBP_PalInvisibleButton' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, OnClicked) == 0x0002B0, "Member 'UWBP_CommonButton_1_C::OnClicked' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, Is_First_Focus_Target) == 0x0002C0, "Member 'UWBP_CommonButton_1_C::Is_First_Focus_Target' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, OnHovered) == 0x0002C8, "Member 'UWBP_CommonButton_1_C::OnHovered' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, OnUnhovered) == 0x0002D8, "Member 'UWBP_CommonButton_1_C::OnUnhovered' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, InitializeMsgID) == 0x0002E8, "Member 'UWBP_CommonButton_1_C::InitializeMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, OverrideHover) == 0x0002F8, "Member 'UWBP_CommonButton_1_C::OverrideHover' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, WWiseHoverAudio) == 0x000300, "Member 'UWBP_CommonButton_1_C::WWiseHoverAudio' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, UnhoverAKAudioEvent) == 0x000308, "Member 'UWBP_CommonButton_1_C::UnhoverAKAudioEvent' has a wrong offset!");
static_assert(offsetof(UWBP_CommonButton_1_C, ClickAKAudioEvent) == 0x000310, "Member 'UWBP_CommonButton_1_C::ClickAKAudioEvent' has a wrong offset!");
