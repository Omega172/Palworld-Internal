...
static_assert(sizeof(ABP_DungeonFixedEntrance_forest_5_C) == 0x000358, "Wrong size on ABP_DungeonFixedEntrance_forest_5_C");
static_assert(offsetof(ABP_DungeonFixedEntrance_forest_5_C, Niagara) == 0x000350, "Member 'ABP_DungeonFixedEntrance_forest_5_C::Niagara' has a wrong offset!");
