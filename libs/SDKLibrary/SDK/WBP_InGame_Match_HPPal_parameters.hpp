...
public:
	...
	uint8                                         Pad_602E[0x6];                                     // 0x0012(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FFixedPoint64                          CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue; // 0x0028(0x0008)(NoDestructor)
	...
	uint8                                         Pad_602F[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_InGame_Match_HPPal_C_BindFromHandle) == 0x000040, "Wrong size on WBP_InGame_Match_HPPal_C_BindFromHandle");
...
static_assert(offsetof(WBP_InGame_Match_HPPal_C_BindFromHandle, CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue) == 0x000028, "Member 'WBP_InGame_Match_HPPal_C_BindFromHandle::CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InGame_Match_HPPal_C_BindFromHandle, CallFunc_Convert_FixedPoint64ToFloat_ReturnValue) == 0x000030, "Member 'WBP_InGame_Match_HPPal_C_BindFromHandle::CallFunc_Convert_FixedPoint64ToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InGame_Match_HPPal_C_BindFromHandle, CallFunc_CheckState_HPPercent_ImplicitCast) == 0x000038, "Member 'WBP_InGame_Match_HPPal_C_BindFromHandle::CallFunc_CheckState_HPPercent_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_6030[0x6];                                     // 0x000A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_6031[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6032[0x3];                                     // 0x0021(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_6033[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_6034[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_Convert_FixedPoint64ToFloat_ReturnValue;  // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsDead_ReturnValue;                       // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6035[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_CheckState_HPPercent_ImplicitCast;        // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_InGame_Match_HPPal_C_On_Update_HP_Binded) == 0x000030, "Wrong size on WBP_InGame_Match_HPPal_C_On_Update_HP_Binded");
...
static_assert(offsetof(WBP_InGame_Match_HPPal_C_On_Update_HP_Binded, CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue) == 0x000010, "Member 'WBP_InGame_Match_HPPal_C_On_Update_HP_Binded::CallFunc_Divide_FixedPoint64FixedPoint64_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InGame_Match_HPPal_C_On_Update_HP_Binded, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'WBP_InGame_Match_HPPal_C_On_Update_HP_Binded::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InGame_Match_HPPal_C_On_Update_HP_Binded, CallFunc_Convert_FixedPoint64ToFloat_ReturnValue) == 0x00001C, "Member 'WBP_InGame_Match_HPPal_C_On_Update_HP_Binded::CallFunc_Convert_FixedPoint64ToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InGame_Match_HPPal_C_On_Update_HP_Binded, CallFunc_IsDead_ReturnValue) == 0x000020, "Member 'WBP_InGame_Match_HPPal_C_On_Update_HP_Binded::CallFunc_IsDead_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InGame_Match_HPPal_C_On_Update_HP_Binded, CallFunc_CheckState_HPPercent_ImplicitCast) == 0x000028, "Member 'WBP_InGame_Match_HPPal_C_On_Update_HP_Binded::CallFunc_CheckState_HPPercent_ImplicitCast' has a wrong offset!");
