...
{
public:
	uint8                                         Pad_4E08[0x8];                                     // 0x0138(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E09[0x7];                                     // 0x0171(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          bActionBreaked;                                    // 0x01A9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4E0A[0x6];                                     // 0x01AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                QueuedTimingLocation;                              // 0x01B0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UBP_Action_WaitLoadingWorldPartition_C) == 0x0001D0, "Wrong size on UBP_Action_WaitLoadingWorldPartition_C");
...
static_assert(offsetof(UBP_Action_WaitLoadingWorldPartition_C, bActionBreaked) == 0x0001A9, "Member 'UBP_Action_WaitLoadingWorldPartition_C::bActionBreaked' has a wrong offset!");
static_assert(offsetof(UBP_Action_WaitLoadingWorldPartition_C, QueuedTimingLocation) == 0x0001B0, "Member 'UBP_Action_WaitLoadingWorldPartition_C::QueuedTimingLocation' has a wrong offset!");
