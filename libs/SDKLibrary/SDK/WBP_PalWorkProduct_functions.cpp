...
void UWBP_PalWorkProduct_C::GetMapObjectLocation(struct FVector* Location)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalWorkProduct_C", "GetMapObjectLocation");

	Params::WBP_PalWorkProduct_C_GetMapObjectLocation Parms{};
