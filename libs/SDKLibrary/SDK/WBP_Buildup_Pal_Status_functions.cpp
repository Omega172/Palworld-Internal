...
class UWidget* UWBP_Buildup_Pal_Status_C::DoCustomNavigation(EUINavigation Param_Navigation)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TMap<EPalCharacterStatusOperationName, int32>Param_Status                                           (BlueprintVisible, BlueprintReadOnly, Parm)

void UWBP_Buildup_Pal_Status_C::InvokeRankup__DelegateSignature(const TMap<EPalCharacterStatusOperationName, int32>& Param_Status)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Status = std::move(Param_Status);
...
void UWBP_Buildup_Pal_Status_C::Predict_Status(EPalCharacterStatusOperationName Param_Status, int32 TargetRank)
{
	static class UFunction* Func = nullptr;
