...
public:
	...
	struct FPalInvaderDatabaseRow                 ChosenInvaderData;                                 // 0x0008(0x0090)(BlueprintVisible, BlueprintReadOnly, Parm)
	struct FDataTableRowHandle                    InvaderGroupName;                                  // 0x0098(0x0010)(Edit, BlueprintVisible, NoDestructor)
	struct FDataTableRowHandle                    TitleMsgID;                                        // 0x00A8(0x0010)(Edit, BlueprintVisible, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_25F7[0x7];                                     // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class FText                                   CallFunc_GetLocalizedText_ReturnValue_1;           // 0x0138(0x0018)()
	class FText                                   CallFunc_GetLocalizedText_ReturnValue_2;           // 0x0150(0x0018)()
...
static_assert(sizeof(WBP_WarningUI_C_DisplayWarning) == 0x000180, "Wrong size on WBP_WarningUI_C_DisplayWarning");
...
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, InvaderGroupName) == 0x000098, "Member 'WBP_WarningUI_C_DisplayWarning::InvaderGroupName' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, TitleMsgID) == 0x0000A8, "Member 'WBP_WarningUI_C_DisplayWarning::TitleMsgID' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, CallFunc_IsValid_ReturnValue) == 0x0000B8, "Member 'WBP_WarningUI_C_DisplayWarning::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, CallFunc_GetLocalizedText_ReturnValue) == 0x0000C0, "Member 'WBP_WarningUI_C_DisplayWarning::CallFunc_GetLocalizedText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, K2Node_MakeStruct_FormatArgumentData) == 0x0000D8, "Member 'WBP_WarningUI_C_DisplayWarning::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, K2Node_MakeArray_Array) == 0x000128, "Member 'WBP_WarningUI_C_DisplayWarning::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, CallFunc_GetLocalizedText_ReturnValue_1) == 0x000138, "Member 'WBP_WarningUI_C_DisplayWarning::CallFunc_GetLocalizedText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, CallFunc_GetLocalizedText_ReturnValue_2) == 0x000150, "Member 'WBP_WarningUI_C_DisplayWarning::CallFunc_GetLocalizedText_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_WarningUI_C_DisplayWarning, CallFunc_Format_ReturnValue) == 0x000168, "Member 'WBP_WarningUI_C_DisplayWarning::CallFunc_Format_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_WarningUI_C_OnInvaderStart) == 0x0000B8, "Wrong size on WBP_WarningUI_C_OnInvaderStart");
...
static_assert(offsetof(WBP_WarningUI_C_OnInvaderStart, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000B0, "Member 'WBP_WarningUI_C_OnInvaderStart::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_25F8[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25F9[0x3];                                     // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_25FA[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
