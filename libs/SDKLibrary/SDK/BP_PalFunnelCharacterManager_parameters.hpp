...
public:
	...
	uint8                                         Pad_3DB6[0x6];                                     // 0x000A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3DB7[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(BP_PalFunnelCharacterManager_C_SetFunnelCharacterActive, bNoEffect) == 0x000009, "Member 'BP_PalFunnelCharacterManager_C_SetFunnelCharacterActive::bNoEffect' has a wrong offset!");
