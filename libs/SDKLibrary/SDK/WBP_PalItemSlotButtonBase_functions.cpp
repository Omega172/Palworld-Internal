...
void UWBP_PalItemSlotButtonBase_C::OnUpdateSlot__DelegateSignature(class UPalItemSlot* Param_Slot)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalItemSlotButtonBase_C", "OnUpdateSlot__DelegateSignature");

	Params::WBP_PalItemSlotButtonBase_C_OnUpdateSlot__DelegateSignature Parms{};
