...
public:
	...
	uint8                                         Pad_4C2A[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C2B[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C2C[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C2D[0x6];                                     // 0x00AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture) == 0x000110, "Wrong size on BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture");
...
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, CallFunc_GetActionComponent_ReturnValue) == 0x0000B8, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::CallFunc_GetActionComponent_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, CallFunc_GetActionTool_ReturnValue) == 0x0000C8, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::CallFunc_GetActionTool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0000D8, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, CallFunc_FinishSpawningActor_ReturnValue) == 0x0000E0, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, CallFunc_GetActionCharacter_ReturnValue_4) == 0x0000E8, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::CallFunc_GetActionCharacter_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, CallFunc_GetController_ReturnValue_1) == 0x0000F0, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::CallFunc_GetController_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, K2Node_DynamicCast_AsPlayer_Controller_1) == 0x0000F8, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::K2Node_DynamicCast_AsPlayer_Controller_1' has a wrong offset!");
static_assert(offsetof(BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture, K2Node_DynamicCast_bSuccess_1) == 0x000100, "Member 'BP_ActionArchitecture_C_ExecuteUbergraph_BP_ActionArchitecture::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
