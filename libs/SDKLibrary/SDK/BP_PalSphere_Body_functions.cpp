...
// Parameters:
// int32                                   Param_CaptureLevel                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TArray<double>                          RateArray                                              (Parm, OutParm)

void ABP_PalSphere_Body_C::CalculateCaptureRate(int32 Param_CaptureLevel, TArray<double>* RateArray)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_CaptureLevel = Param_CaptureLevel;
...
// TArray<double>                          OriginalJudgeRateArray                                 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// TArray<double>                          CriticalJudgeRateArray                                 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
