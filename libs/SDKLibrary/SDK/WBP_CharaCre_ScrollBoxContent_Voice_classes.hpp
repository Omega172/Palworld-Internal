...
public:
	...
	uint8                                         Pad_574E[0x4];                                     // 0x04AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnHoveredVoiceButton;                              // 0x04C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnUnhoveredVoiceButton;                            // 0x04D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(UWBP_CharaCre_ScrollBoxContent_Voice_C) == 0x0004E8, "Wrong size on UWBP_CharaCre_ScrollBoxContent_Voice_C");
...
static_assert(offsetof(UWBP_CharaCre_ScrollBoxContent_Voice_C, OnHoveredVoiceButton) == 0x0004C8, "Member 'UWBP_CharaCre_ScrollBoxContent_Voice_C::OnHoveredVoiceButton' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_ScrollBoxContent_Voice_C, OnUnhoveredVoiceButton) == 0x0004D8, "Member 'UWBP_CharaCre_ScrollBoxContent_Voice_C::OnUnhoveredVoiceButton' has a wrong offset!");
