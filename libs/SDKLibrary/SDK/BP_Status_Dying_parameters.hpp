...
public:
	...
	TDelegate<void(class UPalInteractDelegates* InteractDelegates)> K2Node_CreateDelegate_OutputDelegate;              // 0x0004(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4157[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4158[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4159[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_415A[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_415C[0x7];                                     // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_415D[0x7];                                     // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_GetOwner_ReturnValue_3;                   // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_DownWidgetParameter_C*              CallFunc_CreateDispatchParameterForK2Node_ReturnValue; // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_415E[0x7];                                     // 0x00E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_415F[0x7];                                     // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TDelegate<void(class AActor* Other, EPalInteractiveObjectIndicatorType IndicatorType)> K2Node_CreateDelegate_OutputDelegate_2;            // 0x0110(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class AActor* Other, EPalInteractiveObjectIndicatorType IndicatorType)> K2Node_CreateDelegate_OutputDelegate_3;            // 0x0124(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4162[0x7];                                     // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4163[0x6];                                     // 0x0162(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4164[0x7];                                     // 0x0171(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4165[0x7];                                     // 0x01A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          K2Node_CustomEvent_isIsstantDeath;                 // 0x01D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4166[0x3];                                     // 0x01D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UPalInteractDelegates* InteractDelegates)> K2Node_CreateDelegate_OutputDelegate_4;            // 0x01D4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4167[0x4];                                     // 0x01E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_GetOwner_ReturnValue_8;                   // 0x01E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsInstantDeath__IsInstantDeath;           // 0x01F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4168[0x5];                                     // 0x01F3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4169[0x4];                                     // 0x020C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying) == 0x000220, "Wrong size on BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying");
...
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_GetOwner_ReturnValue_3) == 0x0000C0, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_GetOwner_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_CreateDispatchParameterForK2Node_ReturnValue) == 0x0000C8, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_CreateDispatchParameterForK2Node_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CreateDelegate_OutputDelegate_1) == 0x0000D8, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
...
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CreateDelegate_OutputDelegate_2) == 0x000110, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
...
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CreateDelegate_OutputDelegate_3) == 0x000124, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_GetOwner_ReturnValue_5) == 0x000138, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_GetOwner_ReturnValue_5' has a wrong offset!");
...
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_HasAuthority_ReturnValue) == 0x000148, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_GetOwner_ReturnValue_6) == 0x000150, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_GetOwner_ReturnValue_6' has a wrong offset!");
...
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CustomEvent_isIsstantDeath) == 0x0001D0, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CustomEvent_isIsstantDeath' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CreateDelegate_OutputDelegate_4) == 0x0001D4, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CreateDelegate_OutputDelegate_4' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_GetOwner_ReturnValue_8) == 0x0001E8, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_GetOwner_ReturnValue_8' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_IsInstantDeath__IsInstantDeath) == 0x0001F0, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_IsInstantDeath__IsInstantDeath' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_HasAuthority_ReturnValue_1) == 0x0001F1, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_HasAuthority_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_BooleanAND_ReturnValue) == 0x0001F2, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x0001F8, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_Multiply_DoubleDouble_B_ImplicitCast) == 0x000200, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_Multiply_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, CallFunc_SubDyingHP_SubHP_ImplicitCast) == 0x000208, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::CallFunc_SubDyingHP_SubHP_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CallDelegate_DyingHP_ImplicitCast) == 0x000210, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CallDelegate_DyingHP_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying, K2Node_CallDelegate_MaxDyingHP_ImplicitCast) == 0x000218, "Member 'BP_Status_Dying_C_ExecuteUbergraph_BP_Status_Dying::K2Node_CallDelegate_MaxDyingHP_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_416A[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_416B[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          CallFunc_HasAliveFriendPlayers_ReturnValue;        // 0x001A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x001B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsInArenaByCharacter_ReturnValue;         // 0x001C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_Status_Dying_C_IsInstantDeath_) == 0x000008, "Wrong alignment on BP_Status_Dying_C_IsInstantDeath_");
static_assert(sizeof(BP_Status_Dying_C_IsInstantDeath_) == 0x000020, "Wrong size on BP_Status_Dying_C_IsInstantDeath_");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, IsInstantDeath) == 0x000000, "Member 'BP_Status_Dying_C_IsInstantDeath_::IsInstantDeath' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, CallFunc_GetOwner_ReturnValue) == 0x000008, "Member 'BP_Status_Dying_C_IsInstantDeath_::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, K2Node_DynamicCast_AsPal_Player_Character) == 0x000010, "Member 'BP_Status_Dying_C_IsInstantDeath_::K2Node_DynamicCast_AsPal_Player_Character' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'BP_Status_Dying_C_IsInstantDeath_::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000019, "Member 'BP_Status_Dying_C_IsInstantDeath_::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, CallFunc_HasAliveFriendPlayers_ReturnValue) == 0x00001A, "Member 'BP_Status_Dying_C_IsInstantDeath_::CallFunc_HasAliveFriendPlayers_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, CallFunc_Not_PreBool_ReturnValue) == 0x00001B, "Member 'BP_Status_Dying_C_IsInstantDeath_::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Status_Dying_C_IsInstantDeath_, CallFunc_IsInArenaByCharacter_ReturnValue) == 0x00001C, "Member 'BP_Status_Dying_C_IsInstantDeath_::CallFunc_IsInArenaByCharacter_ReturnValue' has a wrong offset!");
...
static_assert(alignof(BP_Status_Dying_C_ToDeath) == 0x000001, "Wrong alignment on BP_Status_Dying_C_ToDeath");
static_assert(sizeof(BP_Status_Dying_C_ToDeath) == 0x000001, "Wrong size on BP_Status_Dying_C_ToDeath");
static_assert(offsetof(BP_Status_Dying_C_ToDeath, IsIsstantDeath) == 0x000000, "Member 'BP_Status_Dying_C_ToDeath::IsIsstantDeath' has a wrong offset!");
