...
public:
	...
	uint8                                         Pad_5EDB[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5EDC[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5EDD[0x3];                                     // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5EDE[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class USkeletalMeshComponent*                 CallFunc_GetSkeletalMeshComponentFromActorClass_ReturnValue; // 0x0018(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName; // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_5EE0[0x6];                                     // 0x0042(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class USkeletalMesh*                          CallFunc_Map_Find_Value_1;                         // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_5EE1[0x2];                                     // 0x0052(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName_1; // 0x0054(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_NameName_ReturnValue_1;        // 0x005C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5EE2[0x3];                                     // 0x005D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5EE3[0x3];                                     // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   K2Node_Select_Default;                             // 0x006C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5EE4[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalUICaptureCameraOffsetData          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0078(0x00B0)()
	...
	uint8                                         Pad_5EE5[0x7];                                     // 0x0129(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x0130(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_1;  // 0x0300(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_2;  // 0x03E8(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult; // 0x04D0(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
static_assert(alignof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class) == 0x000008, "Wrong alignment on BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class");
static_assert(sizeof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class) == 0x0005B8, "Wrong size on BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class");
...
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, Temp_byte_Variable) == 0x000008, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetStaticParameteComponentFromActorClassr_ReturnValue) == 0x000010, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetStaticParameteComponentFromActorClassr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetSkeletalMeshComponentFromActorClass_ReturnValue) == 0x000018, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetSkeletalMeshComponentFromActorClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_Value) == 0x000020, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_ReturnValue) == 0x000028, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetSkeletalMeshAsset_ReturnValue) == 0x000030, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetSkeletalMeshAsset_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName) == 0x000038, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000040, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_AttachToComponent_ReturnValue) == 0x000041, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_Value_1) == 0x000048, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_ReturnValue_1) == 0x000050, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Contains_ReturnValue) == 0x000051, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName_1) == 0x000054, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_EqualEqual_NameName_ReturnValue_1) == 0x00005C, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_EqualEqual_NameName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, Temp_name_Variable) == 0x000060, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, Temp_bool_Variable) == 0x000068, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, K2Node_Select_Default) == 0x00006C, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetDataTableRowFromName_OutRow) == 0x000078, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000128, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x000130, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x000218, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocation_SweepHitResult_1) == 0x000300, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocation_SweepHitResult_2) == 0x0003E8, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocation_SweepHitResult_2' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult) == 0x0004D0, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5EE6[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5EE7[0x3];                                     // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5EE8[0x7];                                     // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5EE9[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5EEA[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalOptionGraphicsSettings             CallFunc_GetGraphicsSettings_ReturnValue;          // 0x001C(0x0060)(ConstParm, NoDestructor)
};
...
static_assert(sizeof(BP_PalMonsterCaptureSet_C_SetupSkeletalMesh) == 0x000080, "Wrong size on BP_PalMonsterCaptureSet_C_SetupSkeletalMesh");
...
static_assert(offsetof(BP_PalMonsterCaptureSet_C_SetupSkeletalMesh, CallFunc_IsSpiderPal_ReturnValue) == 0x000008, "Member 'BP_PalMonsterCaptureSet_C_SetupSkeletalMesh::CallFunc_IsSpiderPal_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_SetupSkeletalMesh, CallFunc_GetOptionSubsystem_ReturnValue) == 0x000010, "Member 'BP_PalMonsterCaptureSet_C_SetupSkeletalMesh::CallFunc_GetOptionSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_SetupSkeletalMesh, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'BP_PalMonsterCaptureSet_C_SetupSkeletalMesh::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_SetupSkeletalMesh, CallFunc_GetGraphicsSettings_ReturnValue) == 0x00001C, "Member 'BP_PalMonsterCaptureSet_C_SetupSkeletalMesh::CallFunc_GetGraphicsSettings_ReturnValue' has a wrong offset!");
