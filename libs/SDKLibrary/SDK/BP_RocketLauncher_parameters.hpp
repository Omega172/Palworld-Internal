...
public:
	...
	uint8                                         Pad_59B8[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_K2_AttachToComponent_ReturnValue_1;       // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_59B9[0x2];                                     // 0x004A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         K2Node_Event_DeltaSeconds;                         // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_Event_detachActor;                          // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_59BA[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 K2Node_Event_attachActor;                          // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsEmptyMagazine_ReturnValue;              // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsEmptyMagazine_ReturnValue_1;            // 0x006A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_K2_AttachToComponent_ReturnValue_3;       // 0x006B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher) == 0x000070, "Wrong size on BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher");
...
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_CreateDelegate_OutputDelegate_1) == 0x000014, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000028, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_CustomEvent_bulletsNum) == 0x000030, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_CustomEvent_bulletsNum' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_GetOwnerCharacter_ReturnValue) == 0x000038, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_GetOwnerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_GetMainMesh_ReturnValue) == 0x000040, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_GetMainMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue) == 0x000048, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue_1) == 0x000049, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_DeltaSeconds) == 0x00004C, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_detachActor) == 0x000050, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_detachActor' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue_2) == 0x000058, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_attachActor) == 0x000060, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_attachActor' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_IsEmptyMagazine_ReturnValue) == 0x000068, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_IsEmptyMagazine_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_IsValidTimerHandle_ReturnValue) == 0x000069, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_IsValidTimerHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_IsEmptyMagazine_ReturnValue_1) == 0x00006A, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_IsEmptyMagazine_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue_3) == 0x00006B, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue_3' has a wrong offset!");
...
static_assert(sizeof(BP_RocketLauncher_C_OnShoot) == 0x000040, "Wrong size on BP_RocketLauncher_C_OnShoot");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, BulletActor) == 0x000000, "Member 'BP_RocketLauncher_C_OnShoot::BulletActor' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_GetBackFireLocation_Location) == 0x000008, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_GetBackFireLocation_Location' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_GetBackFireLocation_Rotation) == 0x000020, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_GetBackFireLocation_Rotation' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_SpawnSystemAtLocation_ReturnValue) == 0x000038, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_SpawnSystemAtLocation_ReturnValue' has a wrong offset!");
