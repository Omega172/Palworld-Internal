...
public:
	...
	uint8                                         Pad_594B[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBP_VisualEffect_SpawnFadeIn_C) == 0x000098, "Wrong size on UBP_VisualEffect_SpawnFadeIn_C");
...
static_assert(offsetof(UBP_VisualEffect_SpawnFadeIn_C, FadeTime) == 0x000090, "Member 'UBP_VisualEffect_SpawnFadeIn_C::FadeTime' has a wrong offset!");
