...
public:
	...
	uint8                                         Pad_54A2[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_CombatHeliRpidWeaponComponent_C_GetMuzzleFlashEffect) == 0x000008, "Wrong alignment on BP_CombatHeliRpidWeaponComponent_C_GetMuzzleFlashEffect");
static_assert(sizeof(BP_CombatHeliRpidWeaponComponent_C_GetMuzzleFlashEffect) == 0x000008, "Wrong size on BP_CombatHeliRpidWeaponComponent_C_GetMuzzleFlashEffect");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_GetMuzzleFlashEffect, Effect) == 0x000000, "Member 'BP_CombatHeliRpidWeaponComponent_C_GetMuzzleFlashEffect::Effect' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_54A3[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class UMeshComponent*                         Param_GunMesh;                                     // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                         Pad_54A4[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54A6[0x8];                                     // 0x0048(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54A7[0x8];                                     // 0x0118(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54A8[0x8];                                     // 0x01E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet) == 0x000270, "Wrong size on BP_CombatHeliRpidWeaponComponent_C_ShootBullet");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, Temp_int_Variable) == 0x000000, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_GetMuzzleFlashEffect_Effect) == 0x000008, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_GetMuzzleFlashEffect_Effect' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_Add_IntInt_ReturnValue) == 0x000014, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000018, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_MakeVector_ReturnValue) == 0x000020, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_RandomFloatInRange_ReturnValue) == 0x000038, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_RandomFloatInRange_ReturnValue_1) == 0x000040, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_RandomFloatInRange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_GetMuzzleTransform_MzlTF) == 0x000050, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_GetMuzzleTransform_MzlTF' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_MakeRotator_ReturnValue) == 0x0000B0, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_BreakTransform_Location) == 0x0000C8, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_BreakTransform_Rotation) == 0x0000E0, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_BreakTransform_Scale) == 0x0000F8, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_SpawnSystemAtLocation_ReturnValue) == 0x000110, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_SpawnSystemAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_GetMuzzleTransform_MzlTF_1) == 0x000120, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_GetMuzzleTransform_MzlTF_1' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_GetOwner_ReturnValue) == 0x000180, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_BreakTransform_Location_1) == 0x000188, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_BreakTransform_Location_1' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_BreakTransform_Rotation_1) == 0x0001A0, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_BreakTransform_Rotation_1' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_BreakTransform_Scale_1) == 0x0001B8, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_BreakTransform_Scale_1' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_ComposeRotators_ReturnValue) == 0x0001D0, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_ComposeRotators_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_MakeTransform_ReturnValue) == 0x0001F0, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000250, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_FinishSpawningActor_ReturnValue) == 0x000258, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_GetComponentByClass_ReturnValue) == 0x000260, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_MakeRotator_Yaw_ImplicitCast) == 0x000268, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_MakeRotator_Yaw_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_CombatHeliRpidWeaponComponent_C_ShootBullet, CallFunc_MakeRotator_Pitch_ImplicitCast) == 0x00026C, "Member 'BP_CombatHeliRpidWeaponComponent_C_ShootBullet::CallFunc_MakeRotator_Pitch_ImplicitCast' has a wrong offset!");
