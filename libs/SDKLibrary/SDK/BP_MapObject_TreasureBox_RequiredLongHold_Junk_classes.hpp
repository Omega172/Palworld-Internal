...
static_assert(sizeof(ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C) == 0x000460, "Wrong size on ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C");
static_assert(offsetof(ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C, StaticMesh) == 0x000448, "Member 'ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C::StaticMesh' has a wrong offset!");
static_assert(offsetof(ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C, BP_InteractableSphere) == 0x000450, "Member 'ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C::BP_InteractableSphere' has a wrong offset!");
static_assert(offsetof(ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C, IndicatorOrigin) == 0x000458, "Member 'ABP_MapObject_TreasureBox_RequiredLongHold_Junk_C::IndicatorOrigin' has a wrong offset!");
