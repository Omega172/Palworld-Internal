...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UPalMapObjectLabModel*            Param_LabModel                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWBP_LabResearch_C::OnCurrentResearchUpdated(class UPalMapObjectLabModel* Param_LabModel)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_LabResearch_C", "OnCurrentResearchUpdated");

	Params::WBP_LabResearch_C_OnCurrentResearchUpdated Parms{};

	Parms.Param_LabModel = Param_LabModel;
