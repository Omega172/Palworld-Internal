...
public:
	...
	uint8                                         Pad_5313[0xC];                                     // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5314[0x7];                                     // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5315[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5316[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetCharacterSaveParameter_ReturnValue;    // 0x0088(0x02E0)(ConstParm)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue;      // 0x0368(0x0030)(UObjectWrapper, HasGetValueTypeHash)
	class FName                                   CallFunc_GetSaveParameterValue_CharacterID_ReturnValue; // 0x0398(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue_1;    // 0x03A0(0x0030)(UObjectWrapper, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_CompassIcon_ForPal_C_SetupTexture) == 0x0003D0, "Wrong size on WBP_CompassIcon_ForPal_C_SetupTexture");
...
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetCharacterIconTexture_ReturnValue) == 0x000368, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetCharacterIconTexture_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetSaveParameterValue_CharacterID_ReturnValue) == 0x000398, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetSaveParameterValue_CharacterID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetCharacterIconTexture_ReturnValue_1) == 0x0003A0, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetCharacterIconTexture_ReturnValue_1' has a wrong offset!");
