...
public:
	...
	uint8                                         Pad_50A0[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_50A1[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetSaveParameter_ReturnValue;             // 0x0010(0x02E0)(ConstParm)
	int32                                         CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue; // 0x02F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue; // 0x02F4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue; // 0x02F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_Menu_Pal_Potencial_C_SetupByParameter) == 0x000300, "Wrong size on WBP_Menu_Pal_Potencial_C_SetupByParameter");
...
static_assert(offsetof(WBP_Menu_Pal_Potencial_C_SetupByParameter, CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue) == 0x0002F0, "Member 'WBP_Menu_Pal_Potencial_C_SetupByParameter::CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Menu_Pal_Potencial_C_SetupByParameter, CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue) == 0x0002F4, "Member 'WBP_Menu_Pal_Potencial_C_SetupByParameter::CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Menu_Pal_Potencial_C_SetupByParameter, CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue) == 0x0002F8, "Member 'WBP_Menu_Pal_Potencial_C_SetupByParameter::CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue' has a wrong offset!");
