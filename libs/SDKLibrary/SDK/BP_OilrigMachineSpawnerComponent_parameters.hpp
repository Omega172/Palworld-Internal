...
public:
	...
	uint8                                         Pad_41B4[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate) == 0x000060, "Wrong size on BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate");
...
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate, CallFunc_GetOilrigManager_ReturnValue) == 0x000030, "Member 'BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate::CallFunc_GetOilrigManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate, K2Node_CreateDelegate_OutputDelegate) == 0x000038, "Member 'BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate, CallFunc_TryGetIndividualActor_ReturnValue) == 0x000048, "Member 'BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate::CallFunc_TryGetIndividualActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate, CallFunc_GetComponentByClass_ReturnValue) == 0x000050, "Member 'BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate, CallFunc_IsValid_ReturnValue) == 0x000058, "Member 'BP_OilrigMachineSpawnerComponent_C_Spawn_Delegate::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetInitializedCharacterSaveParemter_outParameter; // 0x00D8(0x02E0)()
	bool                                          CallFunc_GetInitializedCharacterSaveParemter_ReturnValue; // 0x03B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_41B6[0x7];                                     // 0x03B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_OilrigMachineSpawnerComponent_C_SpawnMecha) == 0x0003C8, "Wrong size on BP_OilrigMachineSpawnerComponent_C_SpawnMecha");
...
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_SpawnMecha, CallFunc_GetInitializedCharacterSaveParemter_ReturnValue) == 0x0003B8, "Member 'BP_OilrigMachineSpawnerComponent_C_SpawnMecha::CallFunc_GetInitializedCharacterSaveParemter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_SpawnMecha, CallFunc_SpawnNewCharacter_ReturnValue) == 0x0003C0, "Member 'BP_OilrigMachineSpawnerComponent_C_SpawnMecha::CallFunc_SpawnNewCharacter_ReturnValue' has a wrong offset!");
