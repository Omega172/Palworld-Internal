...
static_assert(sizeof(UWBP_BattleEntry_Member_C) == 0x0002B8, "Wrong size on UWBP_BattleEntry_Member_C");
...
static_assert(offsetof(UWBP_BattleEntry_Member_C, ArenaParing) == 0x0002B0, "Member 'UWBP_BattleEntry_Member_C::ArenaParing' has a wrong offset!");
static_assert(offsetof(UWBP_BattleEntry_Member_C, BossTowerEntry) == 0x0002B1, "Member 'UWBP_BattleEntry_Member_C::BossTowerEntry' has a wrong offset!");
