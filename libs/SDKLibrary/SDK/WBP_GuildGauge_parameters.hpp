...
public:
	...
	uint8                                         Pad_5D74[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5D75[0x2];                                     // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5D76[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5D77[0xC];                                     // 0x0124(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5D78[0x2];                                     // 0x000E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5D79[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
// Function WBP_GuildGauge.WBP_GuildGauge_C.SetShield
// 0x0038 (0x0038 - 0x0000)
struct WBP_GuildGauge_C_SetShield final
{
public:
...
static_assert(alignof(WBP_GuildGauge_C_SetShield) == 0x000008, "Wrong alignment on WBP_GuildGauge_C_SetShield");
static_assert(sizeof(WBP_GuildGauge_C_SetShield) == 0x000038, "Wrong size on WBP_GuildGauge_C_SetShield");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, NowSh) == 0x000000, "Member 'WBP_GuildGauge_C_SetShield::NowSh' has a wrong offset!");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, MaxSh) == 0x000008, "Member 'WBP_GuildGauge_C_SetShield::MaxSh' has a wrong offset!");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, CallFunc_Convert_FixedPoint64ToFloat_ReturnValue) == 0x000010, "Member 'WBP_GuildGauge_C_SetShield::CallFunc_Convert_FixedPoint64ToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, CallFunc_Convert_FixedPoint64ToFloat_ReturnValue_1) == 0x000014, "Member 'WBP_GuildGauge_C_SetShield::CallFunc_Convert_FixedPoint64ToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000018, "Member 'WBP_GuildGauge_C_SetShield::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, CallFunc_Divide_DoubleDouble_B_ImplicitCast) == 0x000020, "Member 'WBP_GuildGauge_C_SetShield::CallFunc_Divide_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, CallFunc_Divide_DoubleDouble_A_ImplicitCast) == 0x000028, "Member 'WBP_GuildGauge_C_SetShield::CallFunc_Divide_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_GuildGauge_C_SetShield, CallFunc_SetPercent_percent_ImplicitCast) == 0x000030, "Member 'WBP_GuildGauge_C_SetShield::CallFunc_SetPercent_percent_ImplicitCast' has a wrong offset!");
