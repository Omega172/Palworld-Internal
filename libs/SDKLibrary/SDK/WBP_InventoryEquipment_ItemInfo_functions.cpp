...
void UWBP_InventoryEquipment_ItemInfo_C::GetFoodCategoryName(class UPalStaticItemDataBase* ItemData, class FText* Param_Name)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FPalUICommonItemInfoDisplayData  DisplayInfo                                            (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
// (Private, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FName                             StaticItemId                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
