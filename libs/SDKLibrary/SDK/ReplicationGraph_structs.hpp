...
{
public:
	uint8                                         Pad_1A0D[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A0E[0x8];                                     // 0x0010(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1A0F[0x56];                                    // 0x0012(0x0056)(Fixing Size After Last Property [ Dumper-7 ])
