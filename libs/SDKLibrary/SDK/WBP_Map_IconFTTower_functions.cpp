...
void UWBP_Map_IconFTTower_C::GetInvisibleButton(class UWidget** Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Map_IconFTTower_C", "GetInvisibleButton");

	Params::WBP_Map_IconFTTower_C_GetInvisibleButton Parms{};
