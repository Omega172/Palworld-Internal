...
static_assert(sizeof(UBP_AIADamageReaction_C) == 0x000140, "Wrong size on UBP_AIADamageReaction_C");
...
static_assert(offsetof(UBP_AIADamageReaction_C, IsWaitStepCoolTime) == 0x000138, "Member 'UBP_AIADamageReaction_C::IsWaitStepCoolTime' has a wrong offset!");
