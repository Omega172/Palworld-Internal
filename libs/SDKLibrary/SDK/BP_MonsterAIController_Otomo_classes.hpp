...
public:
	...
	uint8                                         Pad_4919[0x4];                                     // 0x055C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          IsReturningFromFarFlag;                            // 0x05D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void SetIsReturningFromFar(bool Param_IsReturningFromFar);
...
static_assert(sizeof(ABP_MonsterAIController_Otomo_C) == 0x0005E0, "Wrong size on ABP_MonsterAIController_Otomo_C");
...
static_assert(offsetof(ABP_MonsterAIController_Otomo_C, IsReturningFromFarFlag) == 0x0005D8, "Member 'ABP_MonsterAIController_Otomo_C::IsReturningFromFarFlag' has a wrong offset!");
