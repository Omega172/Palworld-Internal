...
void UWBP_MainMenu_Technology_SortCheckBox_C::OnBuildFilterChanged__DelegateSignature(EPalBuildObjectTypeA BuildType, bool Enabled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Technology_SortCheckBox_C", "OnBuildFilterChanged__DelegateSignature");

	Params::WBP_MainMenu_Technology_SortCheckBox_C_OnBuildFilterChanged__DelegateSignature Parms{};
...
void UWBP_MainMenu_Technology_SortCheckBox_C::OnItemFilterChanged__DelegateSignature(EPalItemTypeA ItemType, bool Enabled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Technology_SortCheckBox_C", "OnItemFilterChanged__DelegateSignature");

	Params::WBP_MainMenu_Technology_SortCheckBox_C_OnItemFilterChanged__DelegateSignature Parms{};
