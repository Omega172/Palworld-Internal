...
void UWBP_PalMonsterInframeRender_C::RequestCaptureSkin(class FName CharacterID, class FName SkinName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalMonsterInframeRender_C", "RequestCaptureSkin");

	Params::WBP_PalMonsterInframeRender_C_RequestCaptureSkin Parms{};
