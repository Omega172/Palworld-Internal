...
public:
	...
	uint8                                         Pad_5A05[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGeometry                              K2Node_Event_MyGeometry;                           // 0x0008(0x0040)(IsPlainOldData, NoDestructor)
	float                                         K2Node_Event_InDeltaTime;                          // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5A06[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5A07[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetSaveParameter_ReturnValue;             // 0x0010(0x02E0)(ConstParm)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x02F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5A08[0x3];                                     // 0x02F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue; // 0x02F4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue; // 0x02F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue; // 0x02FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_CanDisplayTalentDetailUI_ReturnValue;     // 0x0300(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail) == 0x000308, "Wrong size on WBP_IngameBossHP_C_Set_Enable_Talent_Detail");
...
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_IsValid_ReturnValue) == 0x0002F0, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue) == 0x0002F4, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue) == 0x0002F8, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue) == 0x0002FC, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_CanDisplayTalentDetailUI_ReturnValue) == 0x000300, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_CanDisplayTalentDetailUI_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5A09[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5A0A[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5A0B[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_IntToText_ReturnValue;               // 0x0008(0x0018)()
};
