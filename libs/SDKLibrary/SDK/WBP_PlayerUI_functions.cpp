...
void UWBP_PlayerUI_C::CreateBossLoupe(class APalCharacter* TargetCharacter)
{
	static class UFunction* Func = nullptr;
...
// struct FGuid                            AttackID                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_PlayerUI_C::OnArenaSequenceStageChanged(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UWBP_PlayerUI_C::OnForceAddBossUI(class APalCharacter* TargetCharacter)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PlayerUI_C", "OnForceAddBossUI");

	Params::WBP_PlayerUI_C_OnForceAddBossUI Parms{};
...
void UWBP_PlayerUI_C::UpdateBuildingAimVisibility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PlayerUI_C", "UpdateBuildingAimVisibility");
