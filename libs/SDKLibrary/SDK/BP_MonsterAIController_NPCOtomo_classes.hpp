...
public:
	...
	uint8                                         Pad_494A[0x7];                                     // 0x0561(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	double                                        SwimTimer;                                         // 0x0570(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsOilrigOtomo;                                     // 0x0578(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_MonsterAIController_NPCOtomo_C) == 0x000580, "Wrong size on ABP_MonsterAIController_NPCOtomo_C");
...
static_assert(offsetof(ABP_MonsterAIController_NPCOtomo_C, SwimTimer) == 0x000570, "Member 'ABP_MonsterAIController_NPCOtomo_C::SwimTimer' has a wrong offset!");
static_assert(offsetof(ABP_MonsterAIController_NPCOtomo_C, IsOilrigOtomo) == 0x000578, "Member 'ABP_MonsterAIController_NPCOtomo_C::IsOilrigOtomo' has a wrong offset!");
