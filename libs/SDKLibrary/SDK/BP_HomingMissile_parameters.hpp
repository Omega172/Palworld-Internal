...
public:
	...
	class AActor*                                 CallFunc_FindBulletOwner_Owner;                    // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_1418[0x4];                                     // 0x0174(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         K2Node_VariableSet_HomingAccelerationMagnitude_ImplicitCast; // 0x01AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_FindBulletOwner_Owner) == 0x000008, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_FindBulletOwner_Owner' has a wrong offset!");
...
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_GetWeaponDamage_ReturnValue) == 0x000170, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_GetWeaponDamage_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_GetExplosionClass_ExplosionClass) == 0x000178, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_GetExplosionClass_ExplosionClass' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000180, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000188, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_FinishSpawningActor_ReturnValue) == 0x000190, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_RandomFloatInRange_ReturnValue) == 0x000198, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, CallFunc_Delay_Duration_ImplicitCast) == 0x0001A8, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile, K2Node_VariableSet_HomingAccelerationMagnitude_ImplicitCast) == 0x0001AC, "Member 'BP_HomingMissile_C_ExecuteUbergraph_BP_HomingMissile::K2Node_VariableSet_HomingAccelerationMagnitude_ImplicitCast' has a wrong offset!");
...
{
public:
	class AActor*                                 Param_Owner;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(BP_HomingMissile_C_FindBulletOwner) == 0x000008, "Wrong alignment on BP_HomingMissile_C_FindBulletOwner");
static_assert(sizeof(BP_HomingMissile_C_FindBulletOwner) == 0x000020, "Wrong size on BP_HomingMissile_C_FindBulletOwner");
static_assert(offsetof(BP_HomingMissile_C_FindBulletOwner, Param_Owner) == 0x000000, "Member 'BP_HomingMissile_C_FindBulletOwner::Param_Owner' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_FindBulletOwner, CallFunc_GetOwner_ReturnValue) == 0x000008, "Member 'BP_HomingMissile_C_FindBulletOwner::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_FindBulletOwner, CallFunc_FindOwnerPalCharacter_ReturnValue) == 0x000010, "Member 'BP_HomingMissile_C_FindBulletOwner::CallFunc_FindOwnerPalCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HomingMissile_C_FindBulletOwner, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'BP_HomingMissile_C_FindBulletOwner::CallFunc_IsValid_ReturnValue' has a wrong offset!");
