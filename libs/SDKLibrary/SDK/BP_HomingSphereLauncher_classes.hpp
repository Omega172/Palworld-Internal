...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_HomingSphereLauncher_C;          // 0x0600(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	TArray<class AActor*>                         TargetList;                                        // 0x0608(0x0010)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
...
static_assert(sizeof(ABP_HomingSphereLauncher_C) == 0x000678, "Wrong size on ABP_HomingSphereLauncher_C");
static_assert(offsetof(ABP_HomingSphereLauncher_C, UberGraphFrame_BP_HomingSphereLauncher_C) == 0x000600, "Member 'ABP_HomingSphereLauncher_C::UberGraphFrame_BP_HomingSphereLauncher_C' has a wrong offset!");
static_assert(offsetof(ABP_HomingSphereLauncher_C, TargetList) == 0x000608, "Member 'ABP_HomingSphereLauncher_C::TargetList' has a wrong offset!");
static_assert(offsetof(ABP_HomingSphereLauncher_C, ItemName_LevelTypeMap) == 0x000618, "Member 'ABP_HomingSphereLauncher_C::ItemName_LevelTypeMap' has a wrong offset!");
static_assert(offsetof(ABP_HomingSphereLauncher_C, OnLaunchPalSphere) == 0x000668, "Member 'ABP_HomingSphereLauncher_C::OnLaunchPalSphere' has a wrong offset!");
