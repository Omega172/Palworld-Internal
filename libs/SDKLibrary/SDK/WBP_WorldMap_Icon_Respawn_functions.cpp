...
void UWBP_WorldMap_Icon_Respawn_C::GetInvisibleButton(class UWidget** Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_WorldMap_Icon_Respawn_C", "GetInvisibleButton");

	Params::WBP_WorldMap_Icon_Respawn_C_GetInvisibleButton Parms{};
