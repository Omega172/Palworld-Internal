...
public:
	...
	uint8                                         Pad_41A6[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_41A7[0x1];                                     // 0x001F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_GetAllChildrenNum_index;                  // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_41A8[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_41A9[0x3];                                     // 0x00D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_41AA[0x2];                                     // 0x00E6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_41AB[0x3];                                     // 0x00ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_41AC[0x7];                                     // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_41AD[0x7];                                     // 0x0131(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_41AE[0x4];                                     // 0x0194(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_Option_HelpGuide_C_Setup) == 0x0001F0, "Wrong size on WBP_Option_HelpGuide_C_Setup");
...
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, Temp_bool_Variable) == 0x00000C, "Member 'WBP_Option_HelpGuide_C_Setup::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, Temp_int_Loop_Counter_Variable) == 0x000010, "Member 'WBP_Option_HelpGuide_C_Setup::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Add_IntInt_ReturnValue) == 0x000014, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, Temp_int_Array_Index_Variable) == 0x000018, "Member 'WBP_Option_HelpGuide_C_Setup::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, Temp_bool_Has_Been_Initd_Variable) == 0x00001C, "Member 'WBP_Option_HelpGuide_C_Setup::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_IsPS5_ReturnValue) == 0x00001D, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_IsPS5_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_IsSteamDeck_ReturnValue) == 0x00001E, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_IsSteamDeck_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_GetAllChildrenNum_index) == 0x000020, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_GetAllChildrenNum_index' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000028, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, K2Node_MakeStruct_FormatArgumentData) == 0x000030, "Member 'WBP_Option_HelpGuide_C_Setup::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_GetHelpGuideDataAsset_ReturnValue) == 0x000080, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_GetHelpGuideDataAsset_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_SpawnObject_ReturnValue) == 0x000088, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Conv_NameToString_ReturnValue) == 0x0000A8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Conv_NameToString_ReturnValue_1) == 0x0000B8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Conv_NameToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Concat_StrStr_ReturnValue) == 0x0000C8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_EndsWith_ReturnValue) == 0x0000D8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_EndsWith_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Conv_StringToName_ReturnValue) == 0x0000DC, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_DoesDataTableRowExist_ReturnValue) == 0x0000E4, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_DoesDataTableRowExist_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_BooleanAND_ReturnValue) == 0x0000E5, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Array_Length_ReturnValue) == 0x0000E8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Less_IntInt_ReturnValue) == 0x0000EC, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, K2Node_Select_Default) == 0x0000F0, "Member 'WBP_Option_HelpGuide_C_Setup::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_EqualEqual_NameName_ReturnValue) == 0x0000F8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, K2Node_MakeStruct_DataTableRowHandle) == 0x000100, "Member 'WBP_Option_HelpGuide_C_Setup::K2Node_MakeStruct_DataTableRowHandle' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_GetLocalizedTextFromHandle_Text) == 0x000110, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_GetLocalizedTextFromHandle_Text' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_SlotAsScrollBoxSlot_ReturnValue) == 0x000128, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_SlotAsScrollBoxSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, Temp_bool_IsClosed_Variable) == 0x000130, "Member 'WBP_Option_HelpGuide_C_Setup::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Conv_IntToInt64_ReturnValue_1) == 0x000138, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Conv_IntToInt64_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, K2Node_MakeStruct_FormatArgumentData_1) == 0x000140, "Member 'WBP_Option_HelpGuide_C_Setup::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Add_IntInt_ReturnValue_1) == 0x000190, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, K2Node_MakeArray_Array) == 0x000198, "Member 'WBP_Option_HelpGuide_C_Setup::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Format_ReturnValue) == 0x0001A8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, K2Node_CreateDelegate_OutputDelegate) == 0x0001C0, "Member 'WBP_Option_HelpGuide_C_Setup::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, K2Node_MakeStruct_Margin) == 0x0001D0, "Member 'WBP_Option_HelpGuide_C_Setup::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, Temp_name_Variable) == 0x0001E0, "Member 'WBP_Option_HelpGuide_C_Setup::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_Setup, CallFunc_Array_RemoveItem_ReturnValue) == 0x0001E8, "Member 'WBP_Option_HelpGuide_C_Setup::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_41AF[0x4];                                     // 0x0184(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_41B2[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide, CallFunc_GetParam_ReturnValue) == 0x000048, "Member 'WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide::CallFunc_GetParam_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide, K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_Help_Guide) == 0x000050, "Member 'WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide::K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_Help_Guide' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide, CallFunc_IsValid_ReturnValue) == 0x000059, "Member 'WBP_Option_HelpGuide_C_ExecuteUbergraph_WBP_Option_HelpGuide::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_41B3[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
