...
public:
	...
	uint8                                         Pad_4FCB[0x7];                                     // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	int32                                         Param_CaptureLevel;                                // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 CallFunc_GetOwnerCharacterOrRiderCharacter_Character; // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalIndividualCharacterHandle*          CallFunc_GetTargetHandle_targetHandle;             // 0x0058(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterHandle*          CallFunc_GetIndividualHandle_ReturnValue;          // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalGameSetting*                        CallFunc_GetGameSetting_ReturnValue;               // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetCaptureLevel_level;                    // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4FCD[0x4];                                     // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_PalSphere_Body_C_CalculateCaptureRate) == 0x000008, "Wrong alignment on BP_PalSphere_Body_C_CalculateCaptureRate");
static_assert(sizeof(BP_PalSphere_Body_C_CalculateCaptureRate) == 0x0000A0, "Wrong size on BP_PalSphere_Body_C_CalculateCaptureRate");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, Param_CaptureLevel) == 0x000000, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::Param_CaptureLevel' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, RateArray) == 0x000008, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::RateArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetOwnerCharacterOrRiderCharacter_Character) == 0x000018, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetOwnerCharacterOrRiderCharacter_Character' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetCharacterManager_ReturnValue) == 0x000020, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetCharacterManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetIndividualIDByActor_ReturnValue) == 0x000028, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetIndividualIDByActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetTargetHandle_targetHandle) == 0x000058, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetTargetHandle_targetHandle' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetIndividualHandle_ReturnValue) == 0x000060, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetIndividualHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetGameSetting_ReturnValue) == 0x000068, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetGameSetting_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetCaptureLevel_level) == 0x000070, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetCaptureLevel_level' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000074, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_CalcCaptureRate_ReturnValue) == 0x000078, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_CalcCaptureRate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CallFunc_GetCalculatedCaptureRate_outCalculatedRateArray) == 0x000080, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CallFunc_GetCalculatedCaptureRate_outCalculatedRateArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, K2Node_FunctionResult_RateArray_ImplicitCast) == 0x000090, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::K2Node_FunctionResult_RateArray_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4FCE[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FCF[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FD0[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FD1[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FD2[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FD3[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FD4[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	int32                                         Phase;                                             // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FD6[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        DelayTime;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                         Pad_4FD9[0x4];                                     // 0x006C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TArray<struct FPalVisualEffectDynamicParameterFloat> K2Node_MakeArray_Array;                            // 0x0088(0x0010)(ReferenceParm)
	...
	struct FRotator                               CallFunc_MakeRotFromY_ReturnValue;                 // 0x00C0(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor;               // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalVisualEffectBase*                   CallFunc_AddVisualEffectForActor_ReturnValue;      // 0x00E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterHandle*          CallFunc_GetTargetHandle_targetHandle;             // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(int32 PhaseCount, class UPalIndividualCharacterHandle* TargetHandle)> K2Node_CreateDelegate_OutputDelegate;              // 0x00F8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_SwitchEnum_CmpSuccess;                      // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FDA[0x7];                                     // 0x0109(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_1;             // 0x0118(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4FDB[0x6];                                     // 0x0122(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalCharacterParameterComponent*        CallFunc_GetCharacterParameterComponent_ReturnValue; // 0x0128(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	double                                        K2Node_CustomEvent_Delay;                          // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_HasAuthority_ReturnValue_1;               // 0x0138(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FDC[0x7];                                     // 0x0139(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_2;             // 0x0140(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4FDD[0x6];                                     // 0x014A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_3;             // 0x0150(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_CustomEvent_phase_1;                        // 0x0158(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FDE[0x4];                                     // 0x015C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FDF[0x4];                                     // 0x0174(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FE0[0x2];                                     // 0x01BE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FE1[0x3];                                     // 0x01D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FE2[0x7];                                     // 0x01E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UPalVisualEffectBase*                   K2Node_CustomEvent_visualEffect;                   // 0x01F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_CustomEvent_phaseCount;                     // 0x01F8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FE3[0x4];                                     // 0x01FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalIndividualCharacterHandle*          K2Node_CustomEvent_TargetHandle;                   // 0x0200(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalIndividualCharacterHandle*          CallFunc_GetTargetHandle_targetHandle_3;           // 0x0208(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_5;             // 0x0210(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AController*                            CallFunc_GetController_ReturnValue;                // 0x0218(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_6;             // 0x0220(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalAIController*                       K2Node_DynamicCast_AsPal_AIController;             // 0x0228(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0230(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FE4[0x7];                                     // 0x0231(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalVisualEffectBase*                   CallFunc_AddVisualEffectForActor_ReturnValue_1;    // 0x0238(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_7;             // 0x0240(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_8;             // 0x0248(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_9;             // 0x0258(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_10;            // 0x0260(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4FE5[0x7];                                     // 0x0389(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UPalVisualEffectBase*                   CallFunc_AddVisualEffectForActor_ReturnValue_2;    // 0x03C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_RandomUnitVector_ReturnValue;             // 0x03E0(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4FE6[0x7];                                     // 0x0411(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UNiagaraSystem*                         CallFunc_Map_Find_Value;                           // 0x0430(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue;                     // 0x0438(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_HasAuthority_ReturnValue_3;               // 0x0439(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FE7[0x6];                                     // 0x043A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraComponent*                      CallFunc_SpawnSystemAtLocation_ReturnValue_2;      // 0x0440(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalIndividualCharacterHandle*          CallFunc_GetTargetHandle_targetHandle_4;           // 0x0450(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalDamageReactionComponent*            CallFunc_GetComponentByClass_ReturnValue;          // 0x0458(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_3;                    // 0x0460(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FE8[0x7];                                     // 0x0461(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor_14;            // 0x0468(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                    CallFunc_FindOwnerPlayer_Player;                   // 0x0470(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalCharacterParameterComponent*        CallFunc_GetCharacterParameterComponent_ReturnValue_1; // 0x0478(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_4;                    // 0x0480(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4FE9[0x7];                                     // 0x0481(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_TickMovement_HitedBall_DeltaTime_ImplicitCast; // 0x0488(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Judging_DeltaTime_ImplicitCast;           // 0x0490(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_TickMovement_MoveToSky_DeltaTime_ImplicitCast; // 0x0498(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Delay_Duration_ImplicitCast;              // 0x04A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Delay_Duration_ImplicitCast_1;            // 0x04A4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Delay_Duration_ImplicitCast_2;            // 0x04A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body) == 0x0004B0, "Wrong size on BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body");
...
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_JudgeFlagArray) == 0x000008, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_JudgeFlagArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_OriginalJudgeRateArray) == 0x000018, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_OriginalJudgeRateArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_CriticalJudgeRateArray) == 0x000028, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_CriticalJudgeRateArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_Event_DeltaSeconds) == 0x000038, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000040, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_FindOwnerPalCharacter_ReturnValue) == 0x000058, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_FindOwnerPalCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_MakeStruct_PalVisualEffectDynamicParameterFloat) == 0x000060, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_MakeStruct_PalVisualEffectDynamicParameterFloat' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000070, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_MakeArray_Array) == 0x000088, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Subtract_VectorVector_ReturnValue) == 0x000098, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_MakeStruct_PalVisualEffectDynamicParameter) == 0x0000B0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_MakeStruct_PalVisualEffectDynamicParameter' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_MakeRotFromY_ReturnValue) == 0x0000C0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_MakeRotFromY_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor) == 0x0000D8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_SpawnSystemAtLocation_ReturnValue) == 0x0000E0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_SpawnSystemAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_AddVisualEffectForActor_ReturnValue) == 0x0000E8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_AddVisualEffectForActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetHandle_targetHandle) == 0x0000F0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetHandle_targetHandle' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CreateDelegate_OutputDelegate) == 0x0000F8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_SwitchEnum_CmpSuccess) == 0x000108, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetHandle_targetHandle_1) == 0x000110, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetHandle_targetHandle_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_1) == 0x000118, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_HasAuthority_ReturnValue) == 0x000120, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_IsValid_ReturnValue) == 0x000121, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetCharacterParameterComponent_ReturnValue) == 0x000128, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetCharacterParameterComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_Delay) == 0x000130, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_Delay' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_HasAuthority_ReturnValue_1) == 0x000138, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_HasAuthority_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_2) == 0x000140, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_2' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_HasAuthority_ReturnValue_2) == 0x000148, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_HasAuthority_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_IsValid_ReturnValue_1) == 0x000149, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_3) == 0x000150, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_3' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_phase_1) == 0x000158, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_phase_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_DelayTime_1) == 0x000160, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_DelayTime_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetHandle_targetHandle_2) == 0x000168, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetHandle_targetHandle_2' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_phase) == 0x000170, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_phase' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_DelayTime) == 0x000178, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_DelayTime' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000180, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetComponentScale_ReturnValue) == 0x000198, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetComponentScale_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_SpawnSystemAtLocation_ReturnValue_1) == 0x0001B0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_SpawnSystemAtLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Array_Length_ReturnValue) == 0x0001B8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x0001BC, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0001BD, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Array_Get_Item) == 0x0001C0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_4) == 0x0001C8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_4' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x0001D0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_IsValid_ReturnValue_2) == 0x0001D8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Round_ReturnValue) == 0x0001DC, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Round_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GreaterEqual_IntInt_ReturnValue_1) == 0x0001E0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GreaterEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetActionComponent_ReturnValue) == 0x0001E8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetActionComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_visualEffect) == 0x0001F0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_visualEffect' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_phaseCount) == 0x0001F8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_phaseCount' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_TargetHandle) == 0x000200, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_TargetHandle' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetHandle_targetHandle_3) == 0x000208, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetHandle_targetHandle_3' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_5) == 0x000210, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_5' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetController_ReturnValue) == 0x000218, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_6) == 0x000220, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_6' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_DynamicCast_AsPal_AIController) == 0x000228, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_DynamicCast_AsPal_AIController' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_DynamicCast_bSuccess) == 0x000230, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_AddVisualEffectForActor_ReturnValue_1) == 0x000238, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_AddVisualEffectForActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_7) == 0x000240, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_7' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_8) == 0x000248, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_8' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetPalCharacterMovementComponent_ReturnValue) == 0x000250, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetPalCharacterMovementComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_9) == 0x000258, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_9' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_10) == 0x000260, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_10' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_AdjustActorToFloor_ReturnValue) == 0x000268, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_AdjustActorToFloor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_11) == 0x000270, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_11' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetMainMesh_ReturnValue) == 0x000278, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetMainMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetComponentLocation_ReturnValue_1) == 0x000280, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetComponentLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetAnimInstance_ReturnValue) == 0x000298, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetAnimInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_SetActorLocation_SweepHitResult) == 0x0002A0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_SetActorLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_SetActorLocation_ReturnValue) == 0x000388, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_SetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CustomEvent_GoolLocation) == 0x000390, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CustomEvent_GoolLocation' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_12) == 0x0003A8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_12' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_CreateDelegate_OutputDelegate_1) == 0x0003B0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_AddVisualEffectForActor_ReturnValue_2) == 0x0003C0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_AddVisualEffectForActor_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x0003C8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_RandomUnitVector_ReturnValue) == 0x0003E0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_RandomUnitVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Conv_DoubleToVector_ReturnValue) == 0x0003F8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Conv_DoubleToVector_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Multiply_VectorVector_ReturnValue) == 0x000418, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Multiply_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Map_Find_Value) == 0x000430, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Map_Find_ReturnValue) == 0x000438, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_HasAuthority_ReturnValue_3) == 0x000439, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_HasAuthority_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_SpawnSystemAtLocation_ReturnValue_2) == 0x000440, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_SpawnSystemAtLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_13) == 0x000448, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_13' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetHandle_targetHandle_4) == 0x000450, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetHandle_targetHandle_4' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetComponentByClass_ReturnValue) == 0x000458, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_IsValid_ReturnValue_3) == 0x000460, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetTargetActor_TargetActor_14) == 0x000468, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetTargetActor_TargetActor_14' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_FindOwnerPlayer_Player) == 0x000470, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_FindOwnerPlayer_Player' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetCharacterParameterComponent_ReturnValue_1) == 0x000478, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetCharacterParameterComponent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_IsValid_ReturnValue_4) == 0x000480, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_TickMovement_HitedBall_DeltaTime_ImplicitCast) == 0x000488, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_TickMovement_HitedBall_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Judging_DeltaTime_ImplicitCast) == 0x000490, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Judging_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_TickMovement_MoveToSky_DeltaTime_ImplicitCast) == 0x000498, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_TickMovement_MoveToSky_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Delay_Duration_ImplicitCast) == 0x0004A0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Delay_Duration_ImplicitCast_1) == 0x0004A4, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Delay_Duration_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Delay_Duration_ImplicitCast_2) == 0x0004A8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Delay_Duration_ImplicitCast_2' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4FEB[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4FEC[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FED[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FEE[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FEF[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FF0[0x2];                                     // 0x0062(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FF1[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FF3[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4FF4[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4FF5[0x2];                                     // 0x000E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FF6[0x6];                                     // 0x0022(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FF7[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4FF9[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APalCharacter*                          CallFunc_GetTargetActor_TargetActor;               // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4FFA[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(BP_PalSphere_Body_C_PlayCaptureAbsorbToBallEffect, CallFunc_IsValid_ReturnValue_1) == 0x0001B8, "Member 'BP_PalSphere_Body_C_PlayCaptureAbsorbToBallEffect::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4FFC[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4FFD[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(BP_PalSphere_Body_C_SetParameterCaptureAbsorbToBallEffectBySize, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'BP_PalSphere_Body_C_SetParameterCaptureAbsorbToBallEffectBySize::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetParameterCaptureAbsorbToBallEffectBySize, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000014, "Member 'BP_PalSphere_Body_C_SetParameterCaptureAbsorbToBallEffectBySize::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4FFE[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4FFF[0x1];                                     // 0x001B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_GetCriticalCaptureLevel_NewParam;         // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetCriticalCaptureLevel_NewParam_1;       // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<double>                                CallFunc_CalculateCaptureRate_RateArray;           // 0x0028(0x0010)(ReferenceParm)
	bool                                          CallFunc_Array_Get_Item;                           // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5001[0x3];                                     // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5002[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_GetOwnerCharacterOrRiderCharacter_Character; // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 CallFunc_GetOwnerCharacterOrRiderCharacter_Character_1; // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_5003[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               CallFunc_GetCameraRotator_ReturnValue;             // 0x0098(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class UPalCharacterManager*                   CallFunc_GetCharacterManager_ReturnValue;          // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalIndividualCharacterHandle*          CallFunc_GetIndividualHandle_ReturnValue;          // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetCaptureLevel_level;                    // 0x0150(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5004[0x4];                                     // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<double>                                CallFunc_CalculateCaptureRate_RateArray_1;         // 0x0158(0x0010)(ReferenceParm)
	int32                                         CallFunc_SelectInt_ReturnValue;                    // 0x0168(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5005[0x4];                                     // 0x016C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<bool>                                  CallFunc_JudgePalCapture_TryAllPhase_outJudgeFlagArray; // 0x0170(0x0010)(ReferenceParm)
	bool                                          CallFunc_IsSkipFirstJudge_isSkip;                  // 0x0180(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_PalSphere_Body_C_SetupInServer) == 0x000008, "Wrong alignment on BP_PalSphere_Body_C_SetupInServer");
static_assert(sizeof(BP_PalSphere_Body_C_SetupInServer) == 0x000188, "Wrong size on BP_PalSphere_Body_C_SetupInServer");
...
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCriticalCaptureLevel_NewParam) == 0x00001C, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCriticalCaptureLevel_NewParam' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, Temp_bool_Variable) == 0x000020, "Member 'BP_PalSphere_Body_C_SetupInServer::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCriticalCaptureLevel_NewParam_1) == 0x000024, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCriticalCaptureLevel_NewParam_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_CalculateCaptureRate_RateArray) == 0x000028, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_CalculateCaptureRate_RateArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_Array_Get_Item) == 0x000038, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_Array_Length_ReturnValue) == 0x00003C, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000040, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetOwnerCharacterOrRiderCharacter_Character) == 0x000048, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetOwnerCharacterOrRiderCharacter_Character' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetOwnerCharacterOrRiderCharacter_Character_1) == 0x000050, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetOwnerCharacterOrRiderCharacter_Character_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetIndividualIDByActor_ReturnValue) == 0x000058, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetIndividualIDByActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, K2Node_DynamicCast_AsPal_Player_Character) == 0x000088, "Member 'BP_PalSphere_Body_C_SetupInServer::K2Node_DynamicCast_AsPal_Player_Character' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, K2Node_DynamicCast_bSuccess) == 0x000090, "Member 'BP_PalSphere_Body_C_SetupInServer::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCameraRotator_ReturnValue) == 0x000098, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCameraRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCharacterManager_ReturnValue) == 0x0000B0, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCharacterManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GreaterGreater_VectorRotator_ReturnValue) == 0x0000B8, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GreaterGreater_VectorRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetIndividualHandle_ReturnValue) == 0x0000D0, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetIndividualHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x0000D8, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_K2_GetActorLocation_ReturnValue) == 0x0000F0, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_Add_VectorVector_ReturnValue) == 0x000108, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000120, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_Add_VectorVector_ReturnValue_1) == 0x000138, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCaptureLevel_level) == 0x000150, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCaptureLevel_level' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_CalculateCaptureRate_RateArray_1) == 0x000158, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_CalculateCaptureRate_RateArray_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_SelectInt_ReturnValue) == 0x000168, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_JudgePalCapture_TryAllPhase_outJudgeFlagArray) == 0x000170, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_JudgePalCapture_TryAllPhase_outJudgeFlagArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_IsSkipFirstJudge_isSkip) == 0x000180, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_IsSkipFirstJudge_isSkip' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5006[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(BP_PalSphere_Body_C_SynchronizeJudgeParameter) == 0x000030, "Wrong size on BP_PalSphere_Body_C_SynchronizeJudgeParameter");
...
static_assert(offsetof(BP_PalSphere_Body_C_SynchronizeJudgeParameter, OriginalJudgeRateArray) == 0x000010, "Member 'BP_PalSphere_Body_C_SynchronizeJudgeParameter::OriginalJudgeRateArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SynchronizeJudgeParameter, CriticalJudgeRateArray) == 0x000020, "Member 'BP_PalSphere_Body_C_SynchronizeJudgeParameter::CriticalJudgeRateArray' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5007[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5008[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5009[0x7];                                     // 0x0181(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_500A[0x1];                                     // 0x0273(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_500B[0x4];                                     // 0x027C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_500C[0x4];                                     // 0x0314(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
