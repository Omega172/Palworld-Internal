...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_PalSphere_Body_Ultimate_C;       // 0x0480(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABP_PalSphere_Body_Ultimate_C) == 0x000488, "Wrong size on ABP_PalSphere_Body_Ultimate_C");
static_assert(offsetof(ABP_PalSphere_Body_Ultimate_C, UberGraphFrame_BP_PalSphere_Body_Ultimate_C) == 0x000480, "Member 'ABP_PalSphere_Body_Ultimate_C::UberGraphFrame_BP_PalSphere_Body_Ultimate_C' has a wrong offset!");
